...
TagFilterForDescribeNatGatewaysInput::TagFilterForDescribeNatGatewaysInput() = default;

RequestBuilder TagFilterForDescribeNatGatewaysInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
