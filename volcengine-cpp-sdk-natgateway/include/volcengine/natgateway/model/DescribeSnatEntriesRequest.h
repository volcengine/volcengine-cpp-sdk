...
*/
#ifndef VOLCENGINE_NATGATEWAY_DESCRIBESNATENTRIESREQUEST_H
#define VOLCENGINE_NATGATEWAY_DESCRIBESNATENTRIESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace natgateway{
        class DescribeSnatEntriesRequest {
        public:
            ...
            const std::vector<std::string> &getSnatEntryIds()const { return  v_snatEntryIds; }
            bool SnatEntryIdsHasBeenSet() const { return v_snatEntryIdsHasBeenSet; }
            void setSnatEntryIds(const std::vector<std::string> &s_snatEntryIds ) {
                v_snatEntryIds = s_snatEntryIds;
                v_snatEntryIdsHasBeenSet = true;
            }
        ...
        private:
            ...
            std::vector<std::string> v_snatEntryIds;
            bool v_snatEntryIdsHasBeenSet;
...
#endif // !VOLCENGINE_NATGATEWAY_DESCRIBESNATENTRIESREQUEST_H