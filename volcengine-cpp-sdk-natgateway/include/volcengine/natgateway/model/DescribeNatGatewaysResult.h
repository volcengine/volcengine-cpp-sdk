...
*/
#ifndef VOLCENGINE_NATGATEWAY_DESCRIBENATGATEWAYSRESULT_H
#define VOLCENGINE_NATGATEWAY_DESCRIBENATGATEWAYSRESULT_H
#include <string>
...
namespace volcengine{
    namespace natgateway{
        ...
        public:
            DescribeNatGatewaysResult() = default;
            ~DescribeNatGatewaysResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<NatGatewayForDescribeNatGatewaysOutput> &getNatGateways() const { return  v_natGateways; }
            void setNatGateways(const std::vector<NatGatewayForDescribeNatGatewaysOutput> &s_natGateways ) {
                v_natGateways = s_natGateways;
            }
        ...
        private:
            std::vector<NatGatewayForDescribeNatGatewaysOutput> v_natGateways;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_NATGATEWAY_DESCRIBENATGATEWAYSRESULT_H