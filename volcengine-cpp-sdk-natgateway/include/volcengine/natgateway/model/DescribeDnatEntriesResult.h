...
*/
#ifndef VOLCENGINE_NATGATEWAY_DESCRIBEDNATENTRIESRESULT_H
#define VOLCENGINE_NATGATEWAY_DESCRIBEDNATENTRIESRESULT_H
#include <string>
...
namespace volcengine{
    namespace natgateway{
        class DescribeDnatEntriesResult {
        public:
            DescribeDnatEntriesResult() = default;
            ~DescribeDnatEntriesResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<DnatEntryForDescribeDnatEntriesOutput> &getDnatEntries() const { return  v_dnatEntries; }
            void setDnatEntries(const std::vector<DnatEntryForDescribeDnatEntriesOutput> &s_dnatEntries ) {
                v_dnatEntries = s_dnatEntries;
            }
        ...
        private:
            std::vector<DnatEntryForDescribeDnatEntriesOutput> v_dnatEntries;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_NATGATEWAY_DESCRIBEDNATENTRIESRESULT_H