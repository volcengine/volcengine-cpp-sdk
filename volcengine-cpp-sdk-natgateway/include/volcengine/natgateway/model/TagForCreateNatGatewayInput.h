...
*/
#ifndef VOLCENGINE_NATGATEWAY_TAGFORCREATENATGATEWAYINPUT_H
#define VOLCENGINE_NATGATEWAY_TAGFORCREATENATGATEWAYINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace natgateway{
        class TagForCreateNatGatewayInput {
        public:
            TagForCreateNatGatewayInput();
            ~TagForCreateNatGatewayInput() = default;
...
#endif // !VOLCENGINE_NATGATEWAY_TAGFORCREATENATGATEWAYINPUT_H