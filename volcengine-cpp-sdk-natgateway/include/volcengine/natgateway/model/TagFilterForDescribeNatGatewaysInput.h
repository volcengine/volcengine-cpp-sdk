...
*/
#ifndef VOLCENGINE_NATGATEWAY_TAGFILTERFORDESCRIBENATGATEWAYSINPUT_H
#define VOLCENGINE_NATGATEWAY_TAGFILTERFORDESCRIBENATGATEWAYSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace natgateway{
        class TagFilterForDescribeNatGatewaysInput {
        public:
            TagFilterForDescribeNatGatewaysInput();
            ~TagFilterForDescribeNatGatewaysInput() = default;
...
#endif // !VOLCENGINE_NATGATEWAY_TAGFILTERFORDESCRIBENATGATEWAYSINPUT_H