...
DescribeListenerHealthRequest::DescribeListenerHealthRequest(){
    v_pageNumber = 0;
...
RequestBuilder DescribeListenerHealthRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeListenerHealth");
    ...
    if(v_onlyUnHealthyHasBeenSet){
        rb.withQuery(chain + "OnlyUnHealthy", v_onlyUnHealthy);
