...
RequestBuilder DeleteRulesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DeleteRules");
    ...
    if(v_ruleIdsHasBeenSet){
      unsigned v_ruleIdsCount = 1;
      for(auto& item : v_ruleIds){
        std::stringstream ss;
        ss << chain << "RuleIds." << v_ruleIdsCount;
