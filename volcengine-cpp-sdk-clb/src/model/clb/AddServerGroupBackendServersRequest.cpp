...
AddServerGroupBackendServersRequest::AddServerGroupBackendServersRequest() = default;

RequestBuilder AddServerGroupBackendServersRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","AddServerGroupBackendServers");
