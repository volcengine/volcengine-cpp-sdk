...
HealthCheckForCreateListenerInput::HealthCheckForCreateListenerInput(){
...
RequestBuilder HealthCheckForCreateListenerInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    ...
    if(v_udpExpectHasBeenSet){
        rb.withQuery(chain + "UdpExpect", v_udpExpect);

    }

    if(v_udpRequestHasBeenSet){
        rb.withQuery(chain + "UdpRequest", v_udpRequest);
