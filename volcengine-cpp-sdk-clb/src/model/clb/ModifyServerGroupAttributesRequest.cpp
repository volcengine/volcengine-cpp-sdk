...
ModifyServerGroupAttributesRequest::ModifyServerGroupAttributesRequest() = default;

RequestBuilder ModifyServerGroupAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyServerGroupAttributes");
