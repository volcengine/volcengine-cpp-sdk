...
RequestBuilder UploadCertificateRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","UploadCertificate");
    ...
    if(v_privateKeyHasBeenSet){
        rb.withQuery(chain + "PrivateKey", v_privateKey);
