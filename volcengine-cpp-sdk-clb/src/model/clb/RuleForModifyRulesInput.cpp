...
RuleForModifyRulesInput::RuleForModifyRulesInput() = default;

RequestBuilder RuleForModifyRulesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    ...
    if(v_ruleIdHasBeenSet){
        rb.withQuery(chain + "RuleId", v_ruleId);
