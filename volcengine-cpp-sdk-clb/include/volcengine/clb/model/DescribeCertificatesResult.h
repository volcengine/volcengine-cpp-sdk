...
*/
#ifndef VOLCENGINE_CLB_DESCRIBECERTIFICATESRESULT_H
#define VOLCENGINE_CLB_DESCRIBECERTIFICATESRESULT_H
#include <string>
...
namespace volcengine{
    namespace clb{
        ...
        public:
            DescribeCertificatesResult() = default;
            ~DescribeCertificatesResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<CertificateForDescribeCertificatesOutput> &getCertificates() const { return  v_certificates; }
            void setCertificates(const std::vector<CertificateForDescribeCertificatesOutput> &s_certificates ) {
                v_certificates = s_certificates;
            }
        ...
        private:
            std::vector<CertificateForDescribeCertificatesOutput> v_certificates;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_CLB_DESCRIBECERTIFICATESRESULT_H