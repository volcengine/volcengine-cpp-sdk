...
*/
#ifndef VOLCENGINE_CLB_HEALTHCHECKFORMODIFYLISTENERATTRIBUTESINPUT_H
#define VOLCENGINE_CLB_HEALTHCHECKFORMODIFYLISTENERATTRIBUTESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class HealthCheckForModifyListenerAttributesInput {
        public:
            HealthCheckForModifyListenerAttributesInput();
            ~HealthCheckForModifyListenerAttributesInput() = default;
...
#endif // !VOLCENGINE_CLB_HEALTHCHECKFORMODIFYLISTENERATTRIBUTESINPUT_H