...
*/
#ifndef VOLCENGINE_CLB_LISTENERFORDESCRIBELISTENERSOUTPUT_H
#define VOLCENGINE_CLB_LISTENERFORDESCRIBELISTENERSOUTPUT_H
#include <string>
...
namespace volcengine{
    namespace clb{
        class ListenerForDescribeListenersOutput {
        public:
            ListenerForDescribeListenersOutput() = default;
            ~ListenerForDescribeListenersOutput() = default;
            ...
            const std::shared_ptr<HealthCheckForDescribeListenersOutput> &getHealthCheck() const { return  v_healthCheck; }
            void setHealthCheck(const std::shared_ptr<HealthCheckForDescribeListenersOutput> &s_healthCheck ) {
            ...
            const int getPersistenceTimeout() const { return  v_persistenceTimeout; }
        ...
        private:
            ...
            std::shared_ptr<HealthCheckForDescribeListenersOutput> v_healthCheck;
...
#endif // !VOLCENGINE_CLB_LISTENERFORDESCRIBELISTENERSOUTPUT_H