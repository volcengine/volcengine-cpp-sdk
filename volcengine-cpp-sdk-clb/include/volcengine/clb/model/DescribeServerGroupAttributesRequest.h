...
*/
#ifndef VOLCENGINE_CLB_DESCRIBESERVERGROUPATTRIBUTESREQUEST_H
#define VOLCENGINE_CLB_DESCRIBESERVERGROUPATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class DescribeServerGroupAttributesRequest {
        public:
            DescribeServerGroupAttributesRequest();
            ~DescribeServerGroupAttributesRequest() = default;
...
#endif // !VOLCENGINE_CLB_DESCRIBESERVERGROUPATTRIBUTESREQUEST_H