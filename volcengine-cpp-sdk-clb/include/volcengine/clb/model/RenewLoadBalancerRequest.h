...
*/
#ifndef VOLCENGINE_CLB_RENEWLOADBALANCERREQUEST_H
#define VOLCENGINE_CLB_RENEWLOADBALANCERREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class RenewLoadBalancerRequest {
        public:
            RenewLoadBalancerRequest();
            ~RenewLoadBalancerRequest() = default;
...
#endif // !VOLCENGINE_CLB_RENEWLOADBALANCERREQUEST_H