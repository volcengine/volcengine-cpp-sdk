...
*/
#ifndef VOLCENGINE_CLB_DESCRIBELISTENERSRESULT_H
#define VOLCENGINE_CLB_DESCRIBELISTENERSRESULT_H
#include <string>
...
namespace volcengine{
    namespace clb{
        ...
        public:
            DescribeListenersResult() = default;
            ~DescribeListenersResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<ListenerForDescribeListenersOutput> &getListeners() const { return  v_listeners; }
            void setListeners(const std::vector<ListenerForDescribeListenersOutput> &s_listeners ) {
        ...
        private:
            std::vector<ListenerForDescribeListenersOutput> v_listeners;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_CLB_DESCRIBELISTENERSRESULT_H