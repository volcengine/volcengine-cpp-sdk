...
*/
#ifndef VOLCENGINE_CLB_DISABLEACCESSLOGREQUEST_H
#define VOLCENGINE_CLB_DISABLEACCESSLOGREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class DisableAccessLogRequest {
        public:
            DisableAccessLogRequest();
            ~DisableAccessLogRequest() = default;
...
#endif // !VOLCENGINE_CLB_DISABLEACCESSLOGREQUEST_H