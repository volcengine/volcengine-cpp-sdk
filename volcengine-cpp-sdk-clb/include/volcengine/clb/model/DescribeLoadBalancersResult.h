...
*/
#ifndef VOLCENGINE_CLB_DESCRIBELOADBALANCERSRESULT_H
#define VOLCENGINE_CLB_DESCRIBELOADBALANCERSRESULT_H
#include <string>
...
namespace volcengine{
    namespace clb{
        ...
        public:
            DescribeLoadBalancersResult() = default;
            ~DescribeLoadBalancersResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<LoadBalancerForDescribeLoadBalancersOutput> &getLoadBalancers() const { return  v_loadBalancers; }
            void setLoadBalancers(const std::vector<LoadBalancerForDescribeLoadBalancersOutput> &s_loadBalancers ) {
                v_loadBalancers = s_loadBalancers;
            }
        ...
        private:
            std::vector<LoadBalancerForDescribeLoadBalancersOutput> v_loadBalancers;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_CLB_DESCRIBELOADBALANCERSRESULT_H