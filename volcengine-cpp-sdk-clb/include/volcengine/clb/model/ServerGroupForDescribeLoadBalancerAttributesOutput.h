...
*/
#ifndef VOLCENGINE_CLB_SERVERGROUPFORDESCRIBELOADBALANCERATTRIBUTESOUTPUT_H
#define VOLCENGINE_CLB_SERVERGROUPFORDESCRIBELOADBALANCERATTRIBUTESOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace clb{
        class ServerGroupForDescribeLoadBalancerAttributesOutput {
        public:
            ServerGroupForDescribeLoadBalancerAttributesOutput() = default;
            ~ServerGroupForDescribeLoadBalancerAttributesOutput() = default;
...
#endif // !VOLCENGINE_CLB_SERVERGROUPFORDESCRIBELOADBALANCERATTRIBUTESOUTPUT_H