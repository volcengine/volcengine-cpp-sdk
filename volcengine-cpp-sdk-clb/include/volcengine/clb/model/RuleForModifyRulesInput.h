...
*/
#ifndef VOLCENGINE_CLB_RULEFORMODIFYRULESINPUT_H
#define VOLCENGINE_CLB_RULEFORMODIFYRULESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class RuleForModifyRulesInput {
        public:
            RuleForModifyRulesInput();
            ~RuleForModifyRulesInput() = default;
            ...
            bool RuleIdHasBeenSet() const { return v_ruleIdHasBeenSet; }
            void setRuleId(const std::string &s_ruleId ) {
                v_ruleId = s_ruleId;
                v_ruleIdHasBeenSet = true;
            }
...
#endif // !VOLCENGINE_CLB_RULEFORMODIFYRULESINPUT_H