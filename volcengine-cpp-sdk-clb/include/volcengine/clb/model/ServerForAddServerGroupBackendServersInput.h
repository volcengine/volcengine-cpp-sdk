...
*/
#ifndef VOLCENGINE_CLB_SERVERFORADDSERVERGROUPBACKENDSERVERSINPUT_H
#define VOLCENGINE_CLB_SERVERFORADDSERVERGROUPBACKENDSERVERSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class ServerForAddServerGroupBackendServersInput {
        public:
            ServerForAddServerGroupBackendServersInput();
            ~ServerForAddServerGroupBackendServersInput() = default;
...
#endif // !VOLCENGINE_CLB_SERVERFORADDSERVERGROUPBACKENDSERVERSINPUT_H