...
*/
#ifndef VOLCENGINE_CLB_LISTTAGSFORRESOURCESREQUEST_H
#define VOLCENGINE_CLB_LISTTAGSFORRESOURCESREQUEST_H
#include <string>
...
#endif // !VOLCENGINE_CLB_LISTTAGSFORRESOURCESREQUEST_H