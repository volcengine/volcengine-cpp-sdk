...
*/
#ifndef VOLCENGINE_CLB_TAGFORCREATEACLINPUT_H
#define VOLCENGINE_CLB_TAGFORCREATEACLINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagForCreateAclInput {
        public:
            TagForCreateAclInput();
            ~TagForCreateAclInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFORCREATEACLINPUT_H