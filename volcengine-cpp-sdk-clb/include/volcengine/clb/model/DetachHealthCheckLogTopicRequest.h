...
*/
#ifndef VOLCENGINE_CLB_DETACHHEALTHCHECKLOGTOPICREQUEST_H
#define VOLCENGINE_CLB_DETACHHEALTHCHECKLOGTOPICREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class DetachHealthCheckLogTopicRequest {
        public:
            DetachHealthCheckLogTopicRequest();
            ~DetachHealthCheckLogTopicRequest() = default;
...
#endif // !VOLCENGINE_CLB_DETACHHEALTHCHECKLOGTOPICREQUEST_H