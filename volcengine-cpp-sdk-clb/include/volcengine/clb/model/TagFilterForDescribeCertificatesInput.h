...
*/
#ifndef VOLCENGINE_CLB_TAGFILTERFORDESCRIBECERTIFICATESINPUT_H
#define VOLCENGINE_CLB_TAGFILTERFORDESCRIBECERTIFICATESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagFilterForDescribeCertificatesInput {
        public:
            TagFilterForDescribeCertificatesInput();
            ~TagFilterForDescribeCertificatesInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFILTERFORDESCRIBECERTIFICATESINPUT_H