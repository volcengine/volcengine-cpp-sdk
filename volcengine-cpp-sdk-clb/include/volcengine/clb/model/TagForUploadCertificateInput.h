...
*/
#ifndef VOLCENGINE_CLB_TAGFORUPLOADCERTIFICATEINPUT_H
#define VOLCENGINE_CLB_TAGFORUPLOADCERTIFICATEINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagForUploadCertificateInput {
        public:
            TagForUploadCertificateInput();
            ~TagForUploadCertificateInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFORUPLOADCERTIFICATEINPUT_H