...
*/
#ifndef VOLCENGINE_CLB_TAGFORCREATELOADBALANCERINPUT_H
#define VOLCENGINE_CLB_TAGFORCREATELOADBALANCERINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagForCreateLoadBalancerInput {
        public:
            TagForCreateLoadBalancerInput();
            ~TagForCreateLoadBalancerInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFORCREATELOADBALANCERINPUT_H