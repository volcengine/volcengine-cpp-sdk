...
*/
#ifndef VOLCENGINE_CLB_CREATERULESREQUEST_H
#define VOLCENGINE_CLB_CREATERULESREQUEST_H
#include <string>
...
namespace volcengine{
    namespace clb{
        ...
        public:
            ...
            const std::vector<RuleForCreateRulesInput> &getRules()const { return  v_rules; }
            bool RulesHasBeenSet() const { return v_rulesHasBeenSet; }
            void setRules(const std::vector<RuleForCreateRulesInput> &s_rules ) {
                v_rules = s_rules;
        ...
        private:
            ...
            std::vector<RuleForCreateRulesInput> v_rules;
            bool v_rulesHasBeenSet;

        };
    }
}
#endif // !VOLCENGINE_CLB_CREATERULESREQUEST_H