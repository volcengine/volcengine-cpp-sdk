...
*/
#ifndef VOLCENGINE_CLB_CREATEHEALTHCHECKLOGPROJECTRESULT_H
#define VOLCENGINE_CLB_CREATEHEALTHCHECKLOGPROJECTRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace clb{
        class CreateHealthCheckLogProjectResult {
        public:
            CreateHealthCheckLogProjectResult() = default;
            ~CreateHealthCheckLogProjectResult() = default;
...
#endif // !VOLCENGINE_CLB_CREATEHEALTHCHECKLOGPROJECTRESULT_H