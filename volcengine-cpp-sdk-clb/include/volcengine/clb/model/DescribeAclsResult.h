...
*/
#ifndef VOLCENGINE_CLB_DESCRIBEACLSRESULT_H
#define VOLCENGINE_CLB_DESCRIBEACLSRESULT_H
#include <string>
...
namespace volcengine{
    namespace clb{
        ...
        public:
            DescribeAclsResult() = default;
            ~DescribeAclsResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<AclForDescribeAclsOutput> &getAcls() const { return  v_acls; }
            void setAcls(const std::vector<AclForDescribeAclsOutput> &s_acls ) {
                v_acls = s_acls;
            }
        ...
        private:
            std::vector<AclForDescribeAclsOutput> v_acls;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_CLB_DESCRIBEACLSRESULT_H