...
*/
#ifndef VOLCENGINE_CLB_TAGFILTERFORDESCRIBELOADBALANCERSINPUT_H
#define VOLCENGINE_CLB_TAGFILTERFORDESCRIBELOADBALANCERSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagFilterForDescribeLoadBalancersInput {
        public:
            TagFilterForDescribeLoadBalancersInput();
            ~TagFilterForDescribeLoadBalancersInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFILTERFORDESCRIBELOADBALANCERSINPUT_H