...
*/
#ifndef VOLCENGINE_CLB_TAGFILTERFORDESCRIBEACLSINPUT_H
#define VOLCENGINE_CLB_TAGFILTERFORDESCRIBEACLSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace clb{
        class TagFilterForDescribeAclsInput {
        public:
            TagFilterForDescribeAclsInput();
            ~TagFilterForDescribeAclsInput() = default;
...
#endif // !VOLCENGINE_CLB_TAGFILTERFORDESCRIBEACLSINPUT_H