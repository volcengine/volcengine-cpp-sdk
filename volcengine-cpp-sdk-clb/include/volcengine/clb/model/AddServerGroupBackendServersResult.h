...
*/
#ifndef VOLCENGINE_CLB_ADDSERVERGROUPBACKENDSERVERSRESULT_H
#define VOLCENGINE_CLB_ADDSERVERGROUPBACKENDSERVERSRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace clb{
        class AddServerGroupBackendServersResult {
        public:
            AddServerGroupBackendServersResult() = default;
            ~AddServerGroupBackendServersResult() = default;
...
#endif // !VOLCENGINE_CLB_ADDSERVERGROUPBACKENDSERVERSRESULT_H