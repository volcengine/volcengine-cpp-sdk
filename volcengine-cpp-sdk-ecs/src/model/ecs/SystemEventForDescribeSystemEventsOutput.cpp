...
void SystemEventForDescribeSystemEventsOutput::fromJsonString(const std::string &input) {
    auto j = json::parse(input);
    if (j.contains("CreatedAt")) j.at("CreatedAt").get_to(v_createdAt);
    if (j.contains("Id")) j.at("Id").get_to(v_id);
    if (j.contains("OperatedEndAt")) j.at("OperatedEndAt").get_to(v_operatedEndAt);
    if (j.contains("OperatedStartAt")) j.at("OperatedStartAt").get_to(v_operatedStartAt);
