...
DescribeInstancesIamRolesRequest::DescribeInstancesIamRolesRequest(){
    v_maxResults = 0;
    v_maxResultsHasBeenSet = false;
}

RequestBuilder DescribeInstancesIamRolesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeInstancesIamRoles");
