...
TagFilterForDescribeImagesInput::TagFilterForDescribeImagesInput() = default;

RequestBuilder TagFilterForDescribeImagesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
