...
RequestBuilder ModifyDeploymentSetAttributeRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyDeploymentSetAttribute");
