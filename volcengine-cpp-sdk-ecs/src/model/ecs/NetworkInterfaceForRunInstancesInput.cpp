...
NetworkInterfaceForRunInstancesInput::NetworkInterfaceForRunInstancesInput() = default;

RequestBuilder NetworkInterfaceForRunInstancesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
