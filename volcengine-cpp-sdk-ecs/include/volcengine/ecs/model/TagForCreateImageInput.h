...
*/
#ifndef VOLCENGINE_ECS_TAGFORCREATEIMAGEINPUT_H
#define VOLCENGINE_ECS_TAGFORCREATEIMAGEINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class TagForCreateImageInput {
        public:
            TagForCreateImageInput();
            ~TagForCreateImageInput() = default;
...
#endif // !VOLCENGINE_ECS_TAGFORCREATEIMAGEINPUT_H