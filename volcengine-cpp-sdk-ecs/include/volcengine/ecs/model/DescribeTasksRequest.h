...
*/
#ifndef VOLCENGINE_ECS_DESCRIBETASKSREQUEST_H
#define VOLCENGINE_ECS_DESCRIBETASKSREQUEST_H
#include <string>
...
namespace volcengine{
    namespace ecs{
        ...
        public:
            ...
            bool ResourceIdHasBeenSet() const { return v_resourceIdHasBeenSet; }
            void setResourceId(const std::string &s_resourceId ) {
                v_resourceId = s_resourceId;
                v_resourceIdHasBeenSet = true;
            }
            const std::vector<std::string> &getTaskIds()const { return  v_taskIds; }
            bool TaskIdsHasBeenSet() const { return v_taskIdsHasBeenSet; }
            void setTaskIds(const std::vector<std::string> &s_taskIds ) {
                v_taskIds = s_taskIds;
                v_taskIdsHasBeenSet = true;
            }
        private:
            ...
            bool v_resourceIdHasBeenSet;

            std::vector<std::string> v_taskIds;
            bool v_taskIdsHasBeenSet;

        };
    }
}
#endif // !VOLCENGINE_ECS_DESCRIBETASKSREQUEST_H