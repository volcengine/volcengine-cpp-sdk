...
*/
#ifndef VOLCENGINE_ECS_DELETEDEPLOYMENTSETREQUEST_H
#define VOLCENGINE_ECS_DELETEDEPLOYMENTSETREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DeleteDeploymentSetRequest {
        public:
...
#endif // !VOLCENGINE_ECS_DELETEDEPLOYMENTSETREQUEST_H