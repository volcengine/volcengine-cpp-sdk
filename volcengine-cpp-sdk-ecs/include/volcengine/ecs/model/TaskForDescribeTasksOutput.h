...
*/
#ifndef VOLCENGINE_ECS_TASKFORDESCRIBETASKSOUTPUT_H
#define VOLCENGINE_ECS_TASKFORDESCRIBETASKSOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace ecs{
        class TaskForDescribeTasksOutput {
        public:
            TaskForDescribeTasksOutput() = default;
            ~TaskForDescribeTasksOutput() = default;
            ...
            const std::string &getEndAt() const { return  v_endAt; }
            void setEndAt(const std::string &s_endAt ) {
                v_endAt = s_endAt;
            }
            ...
            const int getProcess() const { return  v_process; }
            void setProcess(const int s_process ) {
                v_process = s_process;
            }
...
#endif // !VOLCENGINE_ECS_TASKFORDESCRIBETASKSOUTPUT_H