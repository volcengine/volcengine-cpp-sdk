...
*/
#ifndef VOLCENGINE_ECS_MODIFYINSTANCESPECREQUEST_H
#define VOLCENGINE_ECS_MODIFYINSTANCESPECREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class ModifyInstanceSpecRequest {
        public:
...
#endif // !VOLCENGINE_ECS_MODIFYINSTANCESPECREQUEST_H