...
*/
#ifndef VOLCENGINE_ECS_LOCALVOLUMEFORDESCRIBEINSTANCESOUTPUT_H
#define VOLCENGINE_ECS_LOCALVOLUMEFORDESCRIBEINSTANCESOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace ecs{
        class LocalVolumeForDescribeInstancesOutput {
        public:
            LocalVolumeForDescribeInstancesOutput() = default;
            ~LocalVolumeForDescribeInstancesOutput() = default;
...
#endif // !VOLCENGINE_ECS_LOCALVOLUMEFORDESCRIBEINSTANCESOUTPUT_H