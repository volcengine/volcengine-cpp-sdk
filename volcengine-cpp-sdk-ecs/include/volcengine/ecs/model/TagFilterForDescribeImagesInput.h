...
*/
#ifndef VOLCENGINE_ECS_TAGFILTERFORDESCRIBEIMAGESINPUT_H
#define VOLCENGINE_ECS_TAGFILTERFORDESCRIBEIMAGESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class TagFilterForDescribeImagesInput {
        public:
            TagFilterForDescribeImagesInput();
            ~TagFilterForDescribeImagesInput() = default;
...
#endif // !VOLCENGINE_ECS_TAGFILTERFORDESCRIBEIMAGESINPUT_H