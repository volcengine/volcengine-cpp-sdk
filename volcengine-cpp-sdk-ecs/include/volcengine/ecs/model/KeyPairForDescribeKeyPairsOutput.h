...
*/
#ifndef VOLCENGINE_ECS_KEYPAIRFORDESCRIBEKEYPAIRSOUTPUT_H
#define VOLCENGINE_ECS_KEYPAIRFORDESCRIBEKEYPAIRSOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace ecs{
        class KeyPairForDescribeKeyPairsOutput {
        public:
            KeyPairForDescribeKeyPairsOutput() = default;
            ~KeyPairForDescribeKeyPairsOutput() = default;
...
#endif // !VOLCENGINE_ECS_KEYPAIRFORDESCRIBEKEYPAIRSOUTPUT_H