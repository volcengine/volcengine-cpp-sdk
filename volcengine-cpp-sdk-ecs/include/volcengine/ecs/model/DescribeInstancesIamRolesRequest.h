...
*/
#ifndef VOLCENGINE_ECS_DESCRIBEINSTANCESIAMROLESREQUEST_H
#define VOLCENGINE_ECS_DESCRIBEINSTANCESIAMROLESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DescribeInstancesIamRolesRequest {
        public:
            DescribeInstancesIamRolesRequest();
            ~DescribeInstancesIamRolesRequest() = default;
...
#endif // !VOLCENGINE_ECS_DESCRIBEINSTANCESIAMROLESREQUEST_H