...
*/
#ifndef VOLCENGINE_ECS_DESCRIBEINSTANCEECSTERMINALURLREQUEST_H
#define VOLCENGINE_ECS_DESCRIBEINSTANCEECSTERMINALURLREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DescribeInstanceECSTerminalUrlRequest {
        public:
            DescribeInstanceECSTerminalUrlRequest();
            ~DescribeInstanceECSTerminalUrlRequest() = default;
...
#endif // !VOLCENGINE_ECS_DESCRIBEINSTANCEECSTERMINALURLREQUEST_H