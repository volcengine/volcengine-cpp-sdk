...
*/
#ifndef VOLCENGINE_ECS_DETACHKEYPAIRREQUEST_H
#define VOLCENGINE_ECS_DETACHKEYPAIRREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DetachKeyPairRequest {
        public:
...
#endif // !VOLCENGINE_ECS_DETACHKEYPAIRREQUEST_H