...
*/
#ifndef VOLCENGINE_ECS_MODIFYINSTANCESPECRESULT_H
#define VOLCENGINE_ECS_MODIFYINSTANCESPECRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace ecs{
        class ModifyInstanceSpecResult {
        public:
            ModifyInstanceSpecResult() = default;
            ~ModifyInstanceSpecResult() = default;
...
#endif // !VOLCENGINE_ECS_MODIFYINSTANCESPECRESULT_H