...
*/
#ifndef VOLCENGINE_ECS_DESCRIBEUSERDATAREQUEST_H
#define VOLCENGINE_ECS_DESCRIBEUSERDATAREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DescribeUserDataRequest {
        public:
...
#endif // !VOLCENGINE_ECS_DESCRIBEUSERDATAREQUEST_H