...
*/
#ifndef VOLCENGINE_ECS_ASSOCIATEINSTANCESIAMROLEREQUEST_H
#define VOLCENGINE_ECS_ASSOCIATEINSTANCESIAMROLEREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class AssociateInstancesIamRoleRequest {
        public:
            AssociateInstancesIamRoleRequest();
            ~AssociateInstancesIamRoleRequest() = default;
...
#endif // !VOLCENGINE_ECS_ASSOCIATEINSTANCESIAMROLEREQUEST_H