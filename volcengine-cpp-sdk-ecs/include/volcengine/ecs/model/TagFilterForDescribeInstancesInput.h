...
*/
#ifndef VOLCENGINE_ECS_TAGFILTERFORDESCRIBEINSTANCESINPUT_H
#define VOLCENGINE_ECS_TAGFILTERFORDESCRIBEINSTANCESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class TagFilterForDescribeInstancesInput {
        public:
            TagFilterForDescribeInstancesInput();
            ~TagFilterForDescribeInstancesInput() = default;
...
#endif // !VOLCENGINE_ECS_TAGFILTERFORDESCRIBEINSTANCESINPUT_H