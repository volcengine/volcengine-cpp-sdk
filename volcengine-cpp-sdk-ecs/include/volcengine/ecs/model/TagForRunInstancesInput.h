...
*/
#ifndef VOLCENGINE_ECS_TAGFORRUNINSTANCESINPUT_H
#define VOLCENGINE_ECS_TAGFORRUNINSTANCESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class TagForRunInstancesInput {
        public:
            TagForRunInstancesInput();
            ~TagForRunInstancesInput() = default;
...
#endif // !VOLCENGINE_ECS_TAGFORRUNINSTANCESINPUT_H