...
*/
#ifndef VOLCENGINE_ECS_DISASSOCIATEINSTANCESIAMROLEREQUEST_H
#define VOLCENGINE_ECS_DISASSOCIATEINSTANCESIAMROLEREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace ecs{
        class DisassociateInstancesIamRoleRequest {
        public:
            DisassociateInstancesIamRoleRequest();
            ~DisassociateInstancesIamRoleRequest() = default;
            ...
            const std::string &getIamRoleName()const { return  v_iamRoleName; }
            bool IamRoleNameHasBeenSet() const { return v_iamRoleNameHasBeenSet; }
            void setIamRoleName(const std::string &s_iamRoleName ) {
                v_iamRoleName = s_iamRoleName;
                v_iamRoleNameHasBeenSet = true;
            }
        ...
        private:
            ...
            std::string v_iamRoleName;
            bool v_iamRoleNameHasBeenSet;
...
#endif // !VOLCENGINE_ECS_DISASSOCIATEINSTANCESIAMROLEREQUEST_H