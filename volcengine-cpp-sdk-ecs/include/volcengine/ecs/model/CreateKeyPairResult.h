...
*/
#ifndef VOLCENGINE_ECS_CREATEKEYPAIRRESULT_H
#define VOLCENGINE_ECS_CREATEKEYPAIRRESULT_H
#include <string>
...
#endif // !VOLCENGINE_ECS_CREATEKEYPAIRRESULT_H