...
*/
#ifndef VOLCENGINE_VKE_LISTNODESRESULT_H
#define VOLCENGINE_VKE_LISTNODESRESULT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ListNodesResult() = default;
            ~ListNodesResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<ItemForListNodesOutput> &getItems() const { return  v_items; }
            void setItems(const std::vector<ItemForListNodesOutput> &s_items ) {
                v_items = s_items;
            }
        ...
        private:
            std::vector<ItemForListNodesOutput> v_items;
            int v_pageNumber{};
            int v_pageSize{};
            int v_totalCount{};
        };
...
#endif // !VOLCENGINE_VKE_LISTNODESRESULT_H