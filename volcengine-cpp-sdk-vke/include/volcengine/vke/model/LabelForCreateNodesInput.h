...
*/
#ifndef VOLCENGINE_VKE_LABELFORCREATENODESINPUT_H
#define VOLCENGINE_VKE_LABELFORCREATENODESINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LabelForCreateNodesInput {
        public:
            LabelForCreateNodesInput();
            ~LabelForCreateNodesInput() = default;
...
#endif // !VOLCENGINE_VKE_LABELFORCREATENODESINPUT_H