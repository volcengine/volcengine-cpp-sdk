...
*/
#ifndef VOLCENGINE_VKE_TAINTFORCREATEDEFAULTNODEPOOLINPUT_H
#define VOLCENGINE_VKE_TAINTFORCREATEDEFAULTNODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TaintForCreateDefaultNodePoolInput {
        public:
            TaintForCreateDefaultNodePoolInput();
            ~TaintForCreateDefaultNodePoolInput() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::string &getEffect()const { return  v_effect; }
            bool EffectHasBeenSet() const { return v_effectHasBeenSet; }
            void setEffect(const std::string &s_effect ) {
                v_effect = s_effect;
                v_effectHasBeenSet = true;
            }
...
#endif // !VOLCENGINE_VKE_TAINTFORCREATEDEFAULTNODEPOOLINPUT_H