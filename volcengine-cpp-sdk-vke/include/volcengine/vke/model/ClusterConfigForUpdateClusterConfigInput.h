...
*/
#ifndef VOLCENGINE_VKE_CLUSTERCONFIGFORUPDATECLUSTERCONFIGINPUT_H
#define VOLCENGINE_VKE_CLUSTERCONFIGFORUPDATECLUSTERCONFIGINPUT_H
#include <string>
#include "volcengine/core/utils/json.hpp"
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/vke/model/ApiServerPublicAccessConfigForUpdateClusterConfigInput.h"
using namespace nlohmann;

namespace volcengine{
    namespace vke{
        class ClusterConfigForUpdateClusterConfigInput {
        public:
            ClusterConfigForUpdateClusterConfigInput();
            ~ClusterConfigForUpdateClusterConfigInput() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::shared_ptr<ApiServerPublicAccessConfigForUpdateClusterConfigInput> &getApiServerPublicAccessConfig()const { return  v_apiServerPublicAccessConfig; }
            bool ApiServerPublicAccessConfigHasBeenSet() const { return v_apiServerPublicAccessConfigHasBeenSet; }
            void setApiServerPublicAccessConfig(const std::shared_ptr<ApiServerPublicAccessConfigForUpdateClusterConfigInput> &s_apiServerPublicAccessConfig ) {
        ...
        private:
            std::shared_ptr<ApiServerPublicAccessConfigForUpdateClusterConfigInput> v_apiServerPublicAccessConfig;
...
#endif // !VOLCENGINE_VKE_CLUSTERCONFIGFORUPDATECLUSTERCONFIGINPUT_H