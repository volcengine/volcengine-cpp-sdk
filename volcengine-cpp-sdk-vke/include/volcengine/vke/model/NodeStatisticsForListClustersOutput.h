...
*/
#ifndef VOLCENGINE_VKE_NODESTATISTICSFORLISTCLUSTERSOUTPUT_H
#define VOLCENGINE_VKE_NODESTATISTICSFORLISTCLUSTERSOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vke{
        class NodeStatisticsForListClustersOutput {
        public:
            NodeStatisticsForListClustersOutput() = default;
            ~NodeStatisticsForListClustersOutput() = default;
...
#endif // !VOLCENGINE_VKE_NODESTATISTICSFORLISTCLUSTERSOUTPUT_H