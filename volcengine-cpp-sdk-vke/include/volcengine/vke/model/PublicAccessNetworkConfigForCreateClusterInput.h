...
*/
#ifndef VOLCENGINE_VKE_PUBLICACCESSNETWORKCONFIGFORCREATECLUSTERINPUT_H
#define VOLCENGINE_VKE_PUBLICACCESSNETWORKCONFIGFORCREATECLUSTERINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class PublicAccessNetworkConfigForCreateClusterInput {
        public:
            PublicAccessNetworkConfigForCreateClusterInput();
            ~PublicAccessNetworkConfigForCreateClusterInput() = default;
...
#endif // !VOLCENGINE_VKE_PUBLICACCESSNETWORKCONFIGFORCREATECLUSTERINPUT_H