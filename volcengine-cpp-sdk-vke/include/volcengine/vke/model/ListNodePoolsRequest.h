...
*/
#ifndef VOLCENGINE_VKE_LISTNODEPOOLSREQUEST_H
#define VOLCENGINE_VKE_LISTNODEPOOLSREQUEST_H
#include <string>
#include "volcengine/core/utils/json.hpp"
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/vke/model/FilterForListNodePoolsInput.h"
#include "volcengine/vke/model/TagForListNodePoolsInput.h"
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ...
            ~ListNodePoolsRequest() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::shared_ptr<FilterForListNodePoolsInput> &getFilter()const { return  v_filter; }
            bool FilterHasBeenSet() const { return v_filterHasBeenSet; }
            void setFilter(const std::shared_ptr<FilterForListNodePoolsInput> &s_filter ) {
                v_filter = s_filter;
            ...
            const std::vector<TagForListNodePoolsInput> &getTags()const { return  v_tags; }
            bool TagsHasBeenSet() const { return v_tagsHasBeenSet; }
            void setTags(const std::vector<TagForListNodePoolsInput> &s_tags ) {
                v_tags = s_tags;
                v_tagsHasBeenSet = true;
            }
        private:
            std::shared_ptr<FilterForListNodePoolsInput> v_filter;
            ...
            std::vector<TagForListNodePoolsInput> v_tags;
            bool v_tagsHasBeenSet;

        };
    }
}
#endif // !VOLCENGINE_VKE_LISTNODEPOOLSREQUEST_H