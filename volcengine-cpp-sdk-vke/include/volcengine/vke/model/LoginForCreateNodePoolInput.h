...
*/
#ifndef VOLCENGINE_VKE_LOGINFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_LOGINFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LoginForCreateNodePoolInput {
        public:
            LoginForCreateNodePoolInput();
            ~LoginForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_LOGINFORCREATENODEPOOLINPUT_H