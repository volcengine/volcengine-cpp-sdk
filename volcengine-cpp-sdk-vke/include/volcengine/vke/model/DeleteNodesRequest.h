...
*/
#ifndef VOLCENGINE_VKE_DELETENODESREQUEST_H
#define VOLCENGINE_VKE_DELETENODESREQUEST_H
#include <string>
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ...
            bool NodePoolIdHasBeenSet() const { return v_nodePoolIdHasBeenSet; }
            void setNodePoolId(const std::string &s_nodePoolId ) {
                v_nodePoolId = s_nodePoolId;
                v_nodePoolIdHasBeenSet = true;
            }
        private:
            ...
            bool v_nodePoolIdHasBeenSet;

        };
    }
}
#endif // !VOLCENGINE_VKE_DELETENODESREQUEST_H