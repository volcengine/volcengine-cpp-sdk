...
*/
#ifndef VOLCENGINE_VKE_VPCCNICONFIGFORCREATECLUSTERINPUT_H
#define VOLCENGINE_VKE_VPCCNICONFIGFORCREATECLUSTERINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class VpcCniConfigForCreateClusterInput {
        public:
            VpcCniConfigForCreateClusterInput();
            ~VpcCniConfigForCreateClusterInput() = default;
...
#endif // !VOLCENGINE_VKE_VPCCNICONFIGFORCREATECLUSTERINPUT_H