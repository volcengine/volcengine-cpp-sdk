...
*/
#ifndef VOLCENGINE_VKE_LOGINFORLISTNODEPOOLSOUTPUT_H
#define VOLCENGINE_VKE_LOGINFORLISTNODEPOOLSOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vke{
        class LoginForListNodePoolsOutput {
        public:
            LoginForListNodePoolsOutput() = default;
            ~LoginForListNodePoolsOutput() = default;
...
#endif // !VOLCENGINE_VKE_LOGINFORLISTNODEPOOLSOUTPUT_H