...
*/
#ifndef VOLCENGINE_VKE_LISTSUPPORTEDRESOURCETYPESREQUEST_H
#define VOLCENGINE_VKE_LISTSUPPORTEDRESOURCETYPESREQUEST_H
#include <string>
#include "volcengine/core/utils/json.hpp"
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/vke/model/FilterForListSupportedResourceTypesInput.h"
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ...
            ~ListSupportedResourceTypesRequest() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::shared_ptr<FilterForListSupportedResourceTypesInput> &getFilter()const { return  v_filter; }
            bool FilterHasBeenSet() const { return v_filterHasBeenSet; }
            void setFilter(const std::shared_ptr<FilterForListSupportedResourceTypesInput> &s_filter ) {
                v_filter = s_filter;
        ...
        private:
            std::shared_ptr<FilterForListSupportedResourceTypesInput> v_filter;
...
#endif // !VOLCENGINE_VKE_LISTSUPPORTEDRESOURCETYPESREQUEST_H