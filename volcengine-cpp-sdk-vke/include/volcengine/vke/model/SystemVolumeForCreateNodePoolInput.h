...
*/
#ifndef VOLCENGINE_VKE_SYSTEMVOLUMEFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_SYSTEMVOLUMEFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class SystemVolumeForCreateNodePoolInput {
        public:
            SystemVolumeForCreateNodePoolInput();
            ~SystemVolumeForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_SYSTEMVOLUMEFORCREATENODEPOOLINPUT_H