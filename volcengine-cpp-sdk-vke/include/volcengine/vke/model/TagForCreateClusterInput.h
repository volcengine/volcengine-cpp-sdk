...
*/
#ifndef VOLCENGINE_VKE_TAGFORCREATECLUSTERINPUT_H
#define VOLCENGINE_VKE_TAGFORCREATECLUSTERINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForCreateClusterInput {
        public:
            TagForCreateClusterInput();
            ~TagForCreateClusterInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORCREATECLUSTERINPUT_H