...
*/
#ifndef VOLCENGINE_VKE_TAINTFORCREATENODESINPUT_H
#define VOLCENGINE_VKE_TAINTFORCREATENODESINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TaintForCreateNodesInput {
        public:
            TaintForCreateNodesInput();
            ~TaintForCreateNodesInput() = default;
...
#endif // !VOLCENGINE_VKE_TAINTFORCREATENODESINPUT_H