...
*/
#ifndef VOLCENGINE_VKE_TAINTFORUPDATENODEPOOLCONFIGINPUT_H
#define VOLCENGINE_VKE_TAINTFORUPDATENODEPOOLCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TaintForUpdateNodePoolConfigInput {
        public:
            TaintForUpdateNodePoolConfigInput();
            ~TaintForUpdateNodePoolConfigInput() = default;
...
#endif // !VOLCENGINE_VKE_TAINTFORUPDATENODEPOOLCONFIGINPUT_H