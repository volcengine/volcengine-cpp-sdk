...
*/
#ifndef VOLCENGINE_VKE_UPDATEADDONVERSIONREQUEST_H
#define VOLCENGINE_VKE_UPDATEADDONVERSIONREQUEST_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class UpdateAddonVersionRequest {
        public:
            UpdateAddonVersionRequest();
            ~UpdateAddonVersionRequest() = default;
...
#endif // !VOLCENGINE_VKE_UPDATEADDONVERSIONREQUEST_H