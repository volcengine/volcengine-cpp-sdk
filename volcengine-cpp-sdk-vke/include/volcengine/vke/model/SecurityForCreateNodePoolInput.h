...
*/
#ifndef VOLCENGINE_VKE_SECURITYFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_SECURITYFORCREATENODEPOOLINPUT_H
#include <string>
#include "volcengine/core/utils/json.hpp"
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/vke/model/LoginForCreateNodePoolInput.h"
using namespace nlohmann;

namespace volcengine{
    namespace vke{
        class SecurityForCreateNodePoolInput {
        public:
            SecurityForCreateNodePoolInput();
            ~SecurityForCreateNodePoolInput() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::shared_ptr<LoginForCreateNodePoolInput> &getLogin()const { return  v_login; }
            bool LoginHasBeenSet() const { return v_loginHasBeenSet; }
            void setLogin(const std::shared_ptr<LoginForCreateNodePoolInput> &s_login ) {
                v_login = s_login;
        ...
        private:
            std::shared_ptr<LoginForCreateNodePoolInput> v_login;
...
#endif // !VOLCENGINE_VKE_SECURITYFORCREATENODEPOOLINPUT_H