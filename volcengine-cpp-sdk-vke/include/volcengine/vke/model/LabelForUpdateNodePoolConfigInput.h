...
*/
#ifndef VOLCENGINE_VKE_LABELFORUPDATENODEPOOLCONFIGINPUT_H
#define VOLCENGINE_VKE_LABELFORUPDATENODEPOOLCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LabelForUpdateNodePoolConfigInput {
        public:
            LabelForUpdateNodePoolConfigInput();
            ~LabelForUpdateNodePoolConfigInput() = default;
...
#endif // !VOLCENGINE_VKE_LABELFORUPDATENODEPOOLCONFIGINPUT_H