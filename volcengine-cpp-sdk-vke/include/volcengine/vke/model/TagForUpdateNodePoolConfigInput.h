...
*/
#ifndef VOLCENGINE_VKE_TAGFORUPDATENODEPOOLCONFIGINPUT_H
#define VOLCENGINE_VKE_TAGFORUPDATENODEPOOLCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForUpdateNodePoolConfigInput {
        public:
            TagForUpdateNodePoolConfigInput();
            ~TagForUpdateNodePoolConfigInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORUPDATENODEPOOLCONFIGINPUT_H