...
*/
#ifndef VOLCENGINE_VKE_AUTOSCALINGFORUPDATENODEPOOLCONFIGINPUT_H
#define VOLCENGINE_VKE_AUTOSCALINGFORUPDATENODEPOOLCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class AutoScalingForUpdateNodePoolConfigInput {
        public:
            AutoScalingForUpdateNodePoolConfigInput();
            ~AutoScalingForUpdateNodePoolConfigInput() = default;
...
#endif // !VOLCENGINE_VKE_AUTOSCALINGFORUPDATENODEPOOLCONFIGINPUT_H