...
*/
#ifndef VOLCENGINE_VKE_LABELFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_LABELFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LabelForCreateNodePoolInput {
        public:
            LabelForCreateNodePoolInput();
            ~LabelForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_LABELFORCREATENODEPOOLINPUT_H