...
*/
#ifndef VOLCENGINE_VKE_TAGFORCREATEDEFAULTNODEPOOLINPUT_H
#define VOLCENGINE_VKE_TAGFORCREATEDEFAULTNODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForCreateDefaultNodePoolInput {
        public:
            TagForCreateDefaultNodePoolInput();
            ~TagForCreateDefaultNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORCREATEDEFAULTNODEPOOLINPUT_H