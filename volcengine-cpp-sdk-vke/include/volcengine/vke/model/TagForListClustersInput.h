...
*/
#ifndef VOLCENGINE_VKE_TAGFORLISTCLUSTERSINPUT_H
#define VOLCENGINE_VKE_TAGFORLISTCLUSTERSINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForListClustersInput {
        public:
            TagForListClustersInput();
            ~TagForListClustersInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORLISTCLUSTERSINPUT_H