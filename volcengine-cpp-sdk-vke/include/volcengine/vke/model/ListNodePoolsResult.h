...
*/
#ifndef VOLCENGINE_VKE_LISTNODEPOOLSRESULT_H
#define VOLCENGINE_VKE_LISTNODEPOOLSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class ListNodePoolsResult {
        public:
            ListNodePoolsResult() = default;
            ~ListNodePoolsResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<ItemForListNodePoolsOutput> &getItems() const { return  v_items; }
            void setItems(const std::vector<ItemForListNodePoolsOutput> &s_items ) {
                v_items = s_items;
            }
        ...
        private:
            std::vector<ItemForListNodePoolsOutput> v_items;
            int v_pageNumber{};
            int v_pageSize{};
            int v_totalCount{};
        };
...
#endif // !VOLCENGINE_VKE_LISTNODEPOOLSRESULT_H