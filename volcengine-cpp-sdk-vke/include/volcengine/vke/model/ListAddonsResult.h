...
*/
#ifndef VOLCENGINE_VKE_LISTADDONSRESULT_H
#define VOLCENGINE_VKE_LISTADDONSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ListAddonsResult() = default;
            ~ListAddonsResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<ItemForListAddonsOutput> &getItems() const { return  v_items; }
            void setItems(const std::vector<ItemForListAddonsOutput> &s_items ) {
                v_items = s_items;
            }
        ...
        private:
            std::vector<ItemForListAddonsOutput> v_items;
            int v_pageNumber{};
            int v_pageSize{};
            int v_totalCount{};
        };
...
#endif // !VOLCENGINE_VKE_LISTADDONSRESULT_H