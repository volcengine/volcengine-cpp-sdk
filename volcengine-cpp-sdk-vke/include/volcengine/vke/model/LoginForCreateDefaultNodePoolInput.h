...
*/
#ifndef VOLCENGINE_VKE_LOGINFORCREATEDEFAULTNODEPOOLINPUT_H
#define VOLCENGINE_VKE_LOGINFORCREATEDEFAULTNODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LoginForCreateDefaultNodePoolInput {
        public:
            LoginForCreateDefaultNodePoolInput();
            ~LoginForCreateDefaultNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_LOGINFORCREATEDEFAULTNODEPOOLINPUT_H