...
*/
#ifndef VOLCENGINE_VKE_LISTADDONSREQUEST_H
#define VOLCENGINE_VKE_LISTADDONSREQUEST_H
#include <string>
...
namespace volcengine{
    namespace vke{
        ...
        public:
            ...
            const std::shared_ptr<FilterForListAddonsInput> &getFilter()const { return  v_filter; }
            bool FilterHasBeenSet() const { return v_filterHasBeenSet; }
            void setFilter(const std::shared_ptr<FilterForListAddonsInput> &s_filter ) {
                v_filter = s_filter;
        ...
        private:
            std::shared_ptr<FilterForListAddonsInput> v_filter;
...
#endif // !VOLCENGINE_VKE_LISTADDONSREQUEST_H