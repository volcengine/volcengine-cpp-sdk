...
*/
#ifndef VOLCENGINE_VKE_TAGFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_TAGFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForCreateNodePoolInput {
        public:
            TagForCreateNodePoolInput();
            ~TagForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORCREATENODEPOOLINPUT_H