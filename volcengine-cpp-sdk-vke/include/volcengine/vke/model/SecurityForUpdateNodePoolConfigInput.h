...
*/
#ifndef VOLCENGINE_VKE_SECURITYFORUPDATENODEPOOLCONFIGINPUT_H
#define VOLCENGINE_VKE_SECURITYFORUPDATENODEPOOLCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class SecurityForUpdateNodePoolConfigInput {
        public:
            SecurityForUpdateNodePoolConfigInput();
            ~SecurityForUpdateNodePoolConfigInput() = default;

            static RequestBuilder withRequestBuilder(RequestBuilder rb, const std::string &chain);
            json jsonPayload() const;

            const std::shared_ptr<LoginForUpdateNodePoolConfigInput> &getLogin()const { return  v_login; }
            bool LoginHasBeenSet() const { return v_loginHasBeenSet; }
            void setLogin(const std::shared_ptr<LoginForUpdateNodePoolConfigInput> &s_login ) {
                v_login = s_login;
        ...
        private:
            std::shared_ptr<LoginForUpdateNodePoolConfigInput> v_login;
...
#endif // !VOLCENGINE_VKE_SECURITYFORUPDATENODEPOOLCONFIGINPUT_H