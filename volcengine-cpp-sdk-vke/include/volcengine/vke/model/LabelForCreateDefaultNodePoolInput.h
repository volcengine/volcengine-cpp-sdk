...
*/
#ifndef VOLCENGINE_VKE_LABELFORCREATEDEFAULTNODEPOOLINPUT_H
#define VOLCENGINE_VKE_LABELFORCREATEDEFAULTNODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class LabelForCreateDefaultNodePoolInput {
        public:
            LabelForCreateDefaultNodePoolInput();
            ~LabelForCreateDefaultNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_LABELFORCREATEDEFAULTNODEPOOLINPUT_H