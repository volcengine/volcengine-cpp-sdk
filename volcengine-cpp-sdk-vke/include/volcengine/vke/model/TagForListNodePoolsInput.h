...
*/
#ifndef VOLCENGINE_VKE_TAGFORLISTNODEPOOLSINPUT_H
#define VOLCENGINE_VKE_TAGFORLISTNODEPOOLSINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TagForListNodePoolsInput {
        public:
            TagForListNodePoolsInput();
            ~TagForListNodePoolsInput() = default;
...
#endif // !VOLCENGINE_VKE_TAGFORLISTNODEPOOLSINPUT_H