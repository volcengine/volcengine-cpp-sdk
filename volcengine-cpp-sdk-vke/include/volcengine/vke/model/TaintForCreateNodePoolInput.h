...
*/
#ifndef VOLCENGINE_VKE_TAINTFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_TAINTFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class TaintForCreateNodePoolInput {
        public:
            TaintForCreateNodePoolInput();
            ~TaintForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_TAINTFORCREATENODEPOOLINPUT_H