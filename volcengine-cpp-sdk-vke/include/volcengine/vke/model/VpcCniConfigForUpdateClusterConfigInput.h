...
*/
#ifndef VOLCENGINE_VKE_VPCCNICONFIGFORUPDATECLUSTERCONFIGINPUT_H
#define VOLCENGINE_VKE_VPCCNICONFIGFORUPDATECLUSTERCONFIGINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class VpcCniConfigForUpdateClusterConfigInput {
        public:
            VpcCniConfigForUpdateClusterConfigInput();
            ~VpcCniConfigForUpdateClusterConfigInput() = default;
...
#endif // !VOLCENGINE_VKE_VPCCNICONFIGFORUPDATECLUSTERCONFIGINPUT_H