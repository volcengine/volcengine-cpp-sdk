...
*/
#ifndef VOLCENGINE_VKE_DATAVOLUMEFORCREATENODEPOOLINPUT_H
#define VOLCENGINE_VKE_DATAVOLUMEFORCREATENODEPOOLINPUT_H
#include <string>
...
namespace volcengine{
    namespace vke{
        class DataVolumeForCreateNodePoolInput {
        public:
            DataVolumeForCreateNodePoolInput();
            ~DataVolumeForCreateNodePoolInput() = default;
...
#endif // !VOLCENGINE_VKE_DATAVOLUMEFORCREATENODEPOOLINPUT_H