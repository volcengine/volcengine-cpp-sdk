...
FilterForListClustersInput::FilterForListClustersInput(){
    v_deleteProtectionEnabled = false;
    v_deleteProtectionEnabledHasBeenSet = false;
}

RequestBuilder FilterForListClustersInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) {

    return rb;
}

json FilterForListClustersInput::jsonPayload() const {
    json j;
    ...
    if(v_podsConfigPodNetworkModeHasBeenSet){
      j["PodsConfigPodNetworkMode"] = v_podsConfigPodNetworkMode;
    }
