...
SecurityForCreateNodePoolInput::SecurityForCreateNodePoolInput() = default;

RequestBuilder SecurityForCreateNodePoolInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) {

    return rb;
}

json SecurityForCreateNodePoolInput::jsonPayload() const {
    json j;
