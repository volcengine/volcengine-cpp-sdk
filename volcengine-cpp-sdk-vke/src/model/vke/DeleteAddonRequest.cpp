...
DeleteAddonRequest::DeleteAddonRequest() = default;

RequestBuilder DeleteAddonRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","DeleteAddon");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json DeleteAddonRequest::jsonPayload() const {
    json j;
