...
RequestBuilder ListClustersRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","ListClusters");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json ListClustersRequest::jsonPayload() const {
    json j;
