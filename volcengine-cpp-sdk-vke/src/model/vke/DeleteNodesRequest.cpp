...
RequestBuilder DeleteNodesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","DeleteNodes");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json DeleteNodesRequest::jsonPayload() const {
    json j;
    ...
    if(v_nodePoolIdHasBeenSet){
      j["NodePoolId"] = v_nodePoolId;
    }
    return j;
}
