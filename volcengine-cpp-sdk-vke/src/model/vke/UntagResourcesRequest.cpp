...
RequestBuilder UntagResourcesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
...
json UntagResourcesRequest::jsonPayload() const {
    json j;
