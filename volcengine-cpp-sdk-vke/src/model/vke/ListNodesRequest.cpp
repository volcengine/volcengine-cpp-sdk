...
RequestBuilder ListNodesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","ListNodes");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json ListNodesRequest::jsonPayload() const {
    json j;
