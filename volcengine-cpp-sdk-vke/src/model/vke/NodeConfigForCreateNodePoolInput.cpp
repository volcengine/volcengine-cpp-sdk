...
NodeConfigForCreateNodePoolInput::NodeConfigForCreateNodePoolInput(){
...
RequestBuilder NodeConfigForCreateNodePoolInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) {

    return rb;
}

json NodeConfigForCreateNodePoolInput::jsonPayload() const {
    json j;
    ...
    if(v_instanceChargeTypeHasBeenSet){
      j["InstanceChargeType"] = v_instanceChargeType;
    }
