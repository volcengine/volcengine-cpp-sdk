...
RequestBuilder ListAddonsRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","ListAddons");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json ListAddonsRequest::jsonPayload() const {
    json j;
