...
KubernetesConfigForCreateNodesInput::KubernetesConfigForCreateNodesInput(){
    v_cordon = false;
    v_cordonHasBeenSet = false;
}

RequestBuilder KubernetesConfigForCreateNodesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) {

    return rb;
}

json KubernetesConfigForCreateNodesInput::jsonPayload() const {
    json j;
