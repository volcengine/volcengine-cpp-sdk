...
RequestBuilder DeleteNodePoolRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) {
    rb.withQuery("Action","DeleteNodePool");
    rb.withQuery("Version","2022-05-12");

    return rb;
}

json DeleteNodePoolRequest::jsonPayload() const {
    json j;
