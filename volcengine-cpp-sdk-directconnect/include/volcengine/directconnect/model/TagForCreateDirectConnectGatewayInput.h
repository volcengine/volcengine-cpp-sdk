...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_TAGFORCREATEDIRECTCONNECTGATEWAYINPUT_H
#define VOLCENGINE_DIRECTCONNECT_TAGFORCREATEDIRECTCONNECTGATEWAYINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace directconnect{
        class TagForCreateDirectConnectGatewayInput {
        public:
            TagForCreateDirectConnectGatewayInput();
            ~TagForCreateDirectConnectGatewayInput() = default;
...
#endif // !VOLCENGINE_DIRECTCONNECT_TAGFORCREATEDIRECTCONNECTGATEWAYINPUT_H