...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_DELETEDIRECTCONNECTCONNECTIONREQUEST_H
#define VOLCENGINE_DIRECTCONNECT_DELETEDIRECTCONNECTCONNECTIONREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace directconnect{
        class DeleteDirectConnectConnectionRequest {
        public:
            DeleteDirectConnectConnectionRequest();
            ~DeleteDirectConnectConnectionRequest() = default;
...
#endif // !VOLCENGINE_DIRECTCONNECT_DELETEDIRECTCONNECTCONNECTIONREQUEST_H