...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYROUTEATTRIBUTESREQUEST_H
#define VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYROUTEATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace directconnect{
        class DescribeDirectConnectGatewayRouteAttributesRequest {
        public:
            DescribeDirectConnectGatewayRouteAttributesRequest();
            ~DescribeDirectConnectGatewayRouteAttributesRequest() = default;
...
#endif // !VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYROUTEATTRIBUTESREQUEST_H