...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYATTRIBUTESREQUEST_H
#define VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace directconnect{
        class DescribeDirectConnectGatewayAttributesRequest {
        public:
            DescribeDirectConnectGatewayAttributesRequest();
            ~DescribeDirectConnectGatewayAttributesRequest() = default;
...
#endif // !VOLCENGINE_DIRECTCONNECT_DESCRIBEDIRECTCONNECTGATEWAYATTRIBUTESREQUEST_H