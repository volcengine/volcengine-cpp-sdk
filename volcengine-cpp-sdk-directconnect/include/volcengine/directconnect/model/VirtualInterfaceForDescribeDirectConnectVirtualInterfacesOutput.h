...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_VIRTUALINTERFACEFORDESCRIBEDIRECTCONNECTVIRTUALINTERFACESOUTPUT_H
#define VOLCENGINE_DIRECTCONNECT_VIRTUALINTERFACEFORDESCRIBEDIRECTCONNECTVIRTUALINTERFACESOUTPUT_H
#include <string>
...
namespace volcengine{
    namespace directconnect{
        class VirtualInterfaceForDescribeDirectConnectVirtualInterfacesOutput {
        public:
            VirtualInterfaceForDescribeDirectConnectVirtualInterfacesOutput() = default;
            ~VirtualInterfaceForDescribeDirectConnectVirtualInterfacesOutput() = default;
            ...
            const std::vector<TagForDescribeDirectConnectVirtualInterfacesOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeDirectConnectVirtualInterfacesOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::string v_status;
            std::vector<TagForDescribeDirectConnectVirtualInterfacesOutput> v_tags;
...
#endif // !VOLCENGINE_DIRECTCONNECT_VIRTUALINTERFACEFORDESCRIBEDIRECTCONNECTVIRTUALINTERFACESOUTPUT_H