...
*/
#ifndef VOLCENGINE_DIRECTCONNECT_DIRECTCONNECTCONNECTIONFORDESCRIBEDIRECTCONNECTCONNECTIONSOUTPUT_H
#define VOLCENGINE_DIRECTCONNECT_DIRECTCONNECTCONNECTIONFORDESCRIBEDIRECTCONNECTCONNECTIONSOUTPUT_H
#include <string>
...
namespace volcengine{
    namespace directconnect{
        class DirectConnectConnectionForDescribeDirectConnectConnectionsOutput {
        public:
            DirectConnectConnectionForDescribeDirectConnectConnectionsOutput() = default;
            ~DirectConnectConnectionForDescribeDirectConnectConnectionsOutput() = default;
            ...
            const std::vector<TagForDescribeDirectConnectConnectionsOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeDirectConnectConnectionsOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::string v_status;
            std::vector<TagForDescribeDirectConnectConnectionsOutput> v_tags;
            std::string v_updateTime;
            int v_vlanId{};
        };
    }
}
#endif // !VOLCENGINE_DIRECTCONNECT_DIRECTCONNECTCONNECTIONFORDESCRIBEDIRECTCONNECTCONNECTIONSOUTPUT_H