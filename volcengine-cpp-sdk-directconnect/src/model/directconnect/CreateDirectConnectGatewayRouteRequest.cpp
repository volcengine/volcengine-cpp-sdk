...
CreateDirectConnectGatewayRouteRequest::CreateDirectConnectGatewayRouteRequest() = default;

RequestBuilder CreateDirectConnectGatewayRouteRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","CreateDirectConnectGatewayRoute");
