...
DescribeDirectConnectGatewayRoutesRequest::DescribeDirectConnectGatewayRoutesRequest(){
    v_pageNumber = 0;
...
RequestBuilder DescribeDirectConnectGatewayRoutesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeDirectConnectGatewayRoutes");
    ...
    if(v_directConnectGatewayRouteIdsHasBeenSet){
      unsigned v_directConnectGatewayRouteIdsCount = 1;
      for(auto& item : v_directConnectGatewayRouteIds){
        std::stringstream ss;
        ss << chain << "DirectConnectGatewayRouteIds." << v_directConnectGatewayRouteIdsCount;
        rb.withQuery(ss.str(), item);
        v_directConnectGatewayRouteIdsCount ++;
      }
    }
