...
DeleteDirectConnectConnectionRequest::DeleteDirectConnectConnectionRequest() = default;

RequestBuilder DeleteDirectConnectConnectionRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DeleteDirectConnectConnection");
