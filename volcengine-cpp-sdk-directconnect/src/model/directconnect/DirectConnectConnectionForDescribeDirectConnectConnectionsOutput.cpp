...
void DirectConnectConnectionForDescribeDirectConnectConnectionsOutput::fromJsonString(const std::string &input) {
    ...
    if (j.contains("Tags")){
        ...
        for (auto & pre : tagsPres) {
           TagForDescribeDirectConnectConnectionsOutput next;
