...
CreateDirectConnectGatewayRequest::CreateDirectConnectGatewayRequest() = default;

RequestBuilder CreateDirectConnectGatewayRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","CreateDirectConnectGateway");
