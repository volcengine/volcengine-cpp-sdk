...
DeleteDirectConnectGatewayRequest::DeleteDirectConnectGatewayRequest() = default;

RequestBuilder DeleteDirectConnectGatewayRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DeleteDirectConnectGateway");
