...
void VpnConnectionForDescribeVpnConnectionsOutput::fromJsonString(const std::string &input) {
    ...
    if (j.contains("IkeConfig")){
        ...
        auto next = std::make_shared<IkeConfigForDescribeVpnConnectionsOutput>();
    ...
    if (j.contains("IpsecConfig")){
        ...
        auto next = std::make_shared<IpsecConfigForDescribeVpnConnectionsOutput>();
