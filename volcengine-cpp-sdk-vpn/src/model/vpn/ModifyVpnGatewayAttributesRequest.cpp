...
ModifyVpnGatewayAttributesRequest::ModifyVpnGatewayAttributesRequest(){
    v_bandwidth = 0;
    v_bandwidthHasBeenSet = false;
}

RequestBuilder ModifyVpnGatewayAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyVpnGatewayAttributes");
    ...
    if(v_negotiateInstantlyHasBeenSet){
        rb.withQuery(chain + "NegotiateInstantly", v_negotiateInstantly);
    ...
    if(v_vpnGatewayNameHasBeenSet){
        rb.withQuery(chain + "VpnGatewayName", v_vpnGatewayName);
