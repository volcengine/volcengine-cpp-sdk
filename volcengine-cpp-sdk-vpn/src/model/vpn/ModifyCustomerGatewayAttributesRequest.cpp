...
ModifyCustomerGatewayAttributesRequest::ModifyCustomerGatewayAttributesRequest() = default;

RequestBuilder ModifyCustomerGatewayAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyCustomerGatewayAttributes");
