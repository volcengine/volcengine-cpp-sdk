...
*/
#ifndef VOLCENGINE_VPN_DESCRIBECUSTOMERGATEWAYSRESULT_H
#define VOLCENGINE_VPN_DESCRIBECUSTOMERGATEWAYSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpn{
        ...
        public:
            DescribeCustomerGatewaysResult() = default;
            ~DescribeCustomerGatewaysResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<CustomerGatewayForDescribeCustomerGatewaysOutput> &getCustomerGateways() const { return  v_customerGateways; }
            void setCustomerGateways(const std::vector<CustomerGatewayForDescribeCustomerGatewaysOutput> &s_customerGateways ) {
                v_customerGateways = s_customerGateways;
            }
        ...
        private:
            std::vector<CustomerGatewayForDescribeCustomerGatewaysOutput> v_customerGateways;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_VPN_DESCRIBECUSTOMERGATEWAYSRESULT_H