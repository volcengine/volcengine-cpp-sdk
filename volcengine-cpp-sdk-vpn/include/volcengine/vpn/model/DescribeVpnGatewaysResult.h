...
*/
#ifndef VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSRESULT_H
#define VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpn{
        ...
        public:
            DescribeVpnGatewaysResult() = default;
            ~DescribeVpnGatewaysResult() = default;
            ...
            const std::vector<VpnGatewayForDescribeVpnGatewaysOutput> &getVpnGateways() const { return  v_vpnGateways; }
            void setVpnGateways(const std::vector<VpnGatewayForDescribeVpnGatewaysOutput> &s_vpnGateways ) {
        ...
        private:
            ...
            int v_totalCount{};
            std::vector<VpnGatewayForDescribeVpnGatewaysOutput> v_vpnGateways;
        };
    }
}
#endif // !VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSRESULT_H