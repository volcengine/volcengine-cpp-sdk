...
*/
#ifndef VOLCENGINE_VPN_TAGFORCREATEVPNGATEWAYINPUT_H
#define VOLCENGINE_VPN_TAGFORCREATEVPNGATEWAYINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpn{
        class TagForCreateVpnGatewayInput {
        public:
            TagForCreateVpnGatewayInput();
            ~TagForCreateVpnGatewayInput() = default;
...
#endif // !VOLCENGINE_VPN_TAGFORCREATEVPNGATEWAYINPUT_H