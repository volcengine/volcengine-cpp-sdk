...
*/
#ifndef VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSBILLINGRESULT_H
#define VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSBILLINGRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpn{
        class DescribeVpnGatewaysBillingResult {
        public:
            DescribeVpnGatewaysBillingResult() = default;
            ~DescribeVpnGatewaysBillingResult() = default;
            ...
            const std::vector<VpnGatewayForDescribeVpnGatewaysBillingOutput> &getVpnGateways() const { return  v_vpnGateways; }
            void setVpnGateways(const std::vector<VpnGatewayForDescribeVpnGatewaysBillingOutput> &s_vpnGateways ) {
                v_vpnGateways = s_vpnGateways;
            }
        private:
            int v_pageNumber{};
            int v_pageSize{};
            ...
            int v_totalCount{};
            std::vector<VpnGatewayForDescribeVpnGatewaysBillingOutput> v_vpnGateways;
        };
    }
}
#endif // !VOLCENGINE_VPN_DESCRIBEVPNGATEWAYSBILLINGRESULT_H