...
*/
#ifndef VOLCENGINE_VPN_VPNGATEWAYFORDESCRIBEVPNGATEWAYSOUTPUT_H
#define VOLCENGINE_VPN_VPNGATEWAYFORDESCRIBEVPNGATEWAYSOUTPUT_H
#include <string>
...
namespace volcengine{
    namespace vpn{
        class VpnGatewayForDescribeVpnGatewaysOutput {
        public:
            VpnGatewayForDescribeVpnGatewaysOutput() = default;
            ~VpnGatewayForDescribeVpnGatewaysOutput() = default;
            ...
            const std::vector<TagForDescribeVpnGatewaysOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeVpnGatewaysOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::vector<TagForDescribeVpnGatewaysOutput> v_tags;
...
#endif // !VOLCENGINE_VPN_VPNGATEWAYFORDESCRIBEVPNGATEWAYSOUTPUT_H