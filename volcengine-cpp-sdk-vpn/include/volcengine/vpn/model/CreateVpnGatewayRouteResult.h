...
*/
#ifndef VOLCENGINE_VPN_CREATEVPNGATEWAYROUTERESULT_H
#define VOLCENGINE_VPN_CREATEVPNGATEWAYROUTERESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpn{
        class CreateVpnGatewayRouteResult {
        public:
            CreateVpnGatewayRouteResult() = default;
            ~CreateVpnGatewayRouteResult() = default;
...
#endif // !VOLCENGINE_VPN_CREATEVPNGATEWAYROUTERESULT_H