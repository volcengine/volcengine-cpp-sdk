...
*/
#ifndef VOLCENGINE_VPN_DESCRIBEVPNCONNECTIONATTRIBUTESRESULT_H
#define VOLCENGINE_VPN_DESCRIBEVPNCONNECTIONATTRIBUTESRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpn{
        class DescribeVpnConnectionAttributesResult {
        public:
            DescribeVpnConnectionAttributesResult() = default;
            ~DescribeVpnConnectionAttributesResult() = default;
            ...
            const std::shared_ptr<IkeConfigForDescribeVpnConnectionAttributesOutput> &getIkeConfig() const { return  v_ikeConfig; }
            void setIkeConfig(const std::shared_ptr<IkeConfigForDescribeVpnConnectionAttributesOutput> &s_ikeConfig ) {
            ...
            const std::shared_ptr<IpsecConfigForDescribeVpnConnectionAttributesOutput> &getIpsecConfig() const { return  v_ipsecConfig; }
            void setIpsecConfig(const std::shared_ptr<IpsecConfigForDescribeVpnConnectionAttributesOutput> &s_ipsecConfig ) {
        ...
        private:
            ...
            std::shared_ptr<IkeConfigForDescribeVpnConnectionAttributesOutput> v_ikeConfig;
            std::string v_ipAddress;
            std::shared_ptr<IpsecConfigForDescribeVpnConnectionAttributesOutput> v_ipsecConfig;
...
#endif // !VOLCENGINE_VPN_DESCRIBEVPNCONNECTIONATTRIBUTESRESULT_H