...
*/
#ifndef VOLCENGINE_STORAGEEBS_TAGFORCREATETAGSINPUT_H
#define VOLCENGINE_STORAGEEBS_TAGFORCREATETAGSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace storageebs{
        class TagForCreateTagsInput {
        public:
            TagForCreateTagsInput();
            ~TagForCreateTagsInput() = default;
...
#endif // !VOLCENGINE_STORAGEEBS_TAGFORCREATETAGSINPUT_H