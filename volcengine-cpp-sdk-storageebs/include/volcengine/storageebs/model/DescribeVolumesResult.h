...
*/
#ifndef VOLCENGINE_STORAGEEBS_DESCRIBEVOLUMESRESULT_H
#define VOLCENGINE_STORAGEEBS_DESCRIBEVOLUMESRESULT_H
#include <string>
...
namespace volcengine{
    namespace storageebs{
        ...
        public:
            ...
            const std::vector<VolumeForDescribeVolumesOutput> &getVolumes() const { return  v_volumes; }
            void setVolumes(const std::vector<VolumeForDescribeVolumesOutput> &s_volumes ) {
                v_volumes = s_volumes;
            }
        private:
            int v_pageNumber{};
            int v_pageSize{};
            int v_totalCount{};
            std::vector<VolumeForDescribeVolumesOutput> v_volumes;
        };
    }
}
#endif // !VOLCENGINE_STORAGEEBS_DESCRIBEVOLUMESRESULT_H