...
*/
#ifndef VOLCENGINE_STORAGEEBS_TAGFORCREATEVOLUMEINPUT_H
#define VOLCENGINE_STORAGEEBS_TAGFORCREATEVOLUMEINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace storageebs{
        class TagForCreateVolumeInput {
        public:
            TagForCreateVolumeInput();
            ~TagForCreateVolumeInput() = default;
...
#endif // !VOLCENGINE_STORAGEEBS_TAGFORCREATEVOLUMEINPUT_H