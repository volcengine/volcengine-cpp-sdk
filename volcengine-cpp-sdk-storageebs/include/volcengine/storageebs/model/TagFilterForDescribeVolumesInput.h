...
*/
#ifndef VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBEVOLUMESINPUT_H
#define VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBEVOLUMESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace storageebs{
        class TagFilterForDescribeVolumesInput {
        public:
            TagFilterForDescribeVolumesInput();
            ~TagFilterForDescribeVolumesInput() = default;
...
#endif // !VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBEVOLUMESINPUT_H