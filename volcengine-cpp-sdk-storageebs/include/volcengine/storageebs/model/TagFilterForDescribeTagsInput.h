...
*/
#ifndef VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBETAGSINPUT_H
#define VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBETAGSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace storageebs{
        class TagFilterForDescribeTagsInput {
        public:
            TagFilterForDescribeTagsInput();
            ~TagFilterForDescribeTagsInput() = default;
...
#endif // !VOLCENGINE_STORAGEEBS_TAGFILTERFORDESCRIBETAGSINPUT_H