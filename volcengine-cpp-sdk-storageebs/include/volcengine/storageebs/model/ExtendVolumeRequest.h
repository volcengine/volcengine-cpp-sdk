...
*/
#ifndef VOLCENGINE_STORAGEEBS_EXTENDVOLUMEREQUEST_H
#define VOLCENGINE_STORAGEEBS_EXTENDVOLUMEREQUEST_H
#include <string>
...
namespace volcengine{
    namespace storageebs{
        ...
        public:
            ...
            const std::string &getNewSize()const { return  v_newSize; }
            bool NewSizeHasBeenSet() const { return v_newSizeHasBeenSet; }
            void setNewSize(const std::string &s_newSize ) {
                v_newSize = s_newSize;
                v_newSizeHasBeenSet = true;
            }
        ...
        private:
            ...
            std::string v_newSize;
            bool v_newSizeHasBeenSet;
...
#endif // !VOLCENGINE_STORAGEEBS_EXTENDVOLUMEREQUEST_H