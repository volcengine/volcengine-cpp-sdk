...
*/
#ifndef VOLCENGINE_VPC_DISASSOCIATEHAVIPREQUEST_H
#define VOLCENGINE_VPC_DISASSOCIATEHAVIPREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class DisassociateHaVipRequest {
        public:
            DisassociateHaVipRequest();
            ~DisassociateHaVipRequest() = default;
...
#endif // !VOLCENGINE_VPC_DISASSOCIATEHAVIPREQUEST_H