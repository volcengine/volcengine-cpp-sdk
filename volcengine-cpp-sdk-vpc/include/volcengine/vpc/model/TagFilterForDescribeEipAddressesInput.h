...
*/
#ifndef VOLCENGINE_VPC_TAGFILTERFORDESCRIBEEIPADDRESSESINPUT_H
#define VOLCENGINE_VPC_TAGFILTERFORDESCRIBEEIPADDRESSESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagFilterForDescribeEipAddressesInput {
        public:
            TagFilterForDescribeEipAddressesInput();
            ~TagFilterForDescribeEipAddressesInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFILTERFORDESCRIBEEIPADDRESSESINPUT_H