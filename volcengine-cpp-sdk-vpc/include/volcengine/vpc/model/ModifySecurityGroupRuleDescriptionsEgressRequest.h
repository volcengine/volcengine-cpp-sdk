...
*/
#ifndef VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSEGRESSREQUEST_H
#define VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSEGRESSREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class ModifySecurityGroupRuleDescriptionsEgressRequest {
        public:
            ModifySecurityGroupRuleDescriptionsEgressRequest();
            ~ModifySecurityGroupRuleDescriptionsEgressRequest() = default;
...
#endif // !VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSEGRESSREQUEST_H