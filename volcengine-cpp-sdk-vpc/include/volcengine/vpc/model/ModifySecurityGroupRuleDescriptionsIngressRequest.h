...
*/
#ifndef VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSINGRESSREQUEST_H
#define VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSINGRESSREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class ModifySecurityGroupRuleDescriptionsIngressRequest {
        public:
            ModifySecurityGroupRuleDescriptionsIngressRequest();
            ~ModifySecurityGroupRuleDescriptionsIngressRequest() = default;
...
#endif // !VOLCENGINE_VPC_MODIFYSECURITYGROUPRULEDESCRIPTIONSINGRESSREQUEST_H