...
*/
#ifndef VOLCENGINE_VPC_TAGFORCREATEBANDWIDTHPACKAGEINPUT_H
#define VOLCENGINE_VPC_TAGFORCREATEBANDWIDTHPACKAGEINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagForCreateBandwidthPackageInput {
        public:
            TagForCreateBandwidthPackageInput();
            ~TagForCreateBandwidthPackageInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFORCREATEBANDWIDTHPACKAGEINPUT_H