...
*/
#ifndef VOLCENGINE_VPC_TAGFORCREATEVPCINPUT_H
#define VOLCENGINE_VPC_TAGFORCREATEVPCINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagForCreateVpcInput {
        public:
            TagForCreateVpcInput();
            ~TagForCreateVpcInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFORCREATEVPCINPUT_H