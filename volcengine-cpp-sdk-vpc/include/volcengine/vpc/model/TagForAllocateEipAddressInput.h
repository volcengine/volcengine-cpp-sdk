...
*/
#ifndef VOLCENGINE_VPC_TAGFORALLOCATEEIPADDRESSINPUT_H
#define VOLCENGINE_VPC_TAGFORALLOCATEEIPADDRESSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagForAllocateEipAddressInput {
        public:
            TagForAllocateEipAddressInput();
            ~TagForAllocateEipAddressInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFORALLOCATEEIPADDRESSINPUT_H