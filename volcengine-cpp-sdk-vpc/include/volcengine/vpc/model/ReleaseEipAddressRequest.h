...
*/
#ifndef VOLCENGINE_VPC_RELEASEEIPADDRESSREQUEST_H
#define VOLCENGINE_VPC_RELEASEEIPADDRESSREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class ReleaseEipAddressRequest {
        public:
...
#endif // !VOLCENGINE_VPC_RELEASEEIPADDRESSREQUEST_H