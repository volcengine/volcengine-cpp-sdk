...
*/
#ifndef VOLCENGINE_VPC_DESCRIBEVPCSRESULT_H
#define VOLCENGINE_VPC_DESCRIBEVPCSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpc{
        ...
        public:
            ...
            const std::vector<VpcForDescribeVpcsOutput> &getVpcs() const { return  v_vpcs; }
            void setVpcs(const std::vector<VpcForDescribeVpcsOutput> &s_vpcs ) {
                v_vpcs = s_vpcs;
            }
        private:
            int v_pageNumber{};
            ...
            int v_totalCount{};
            std::vector<VpcForDescribeVpcsOutput> v_vpcs;
        };
    }
}
#endif // !VOLCENGINE_VPC_DESCRIBEVPCSRESULT_H