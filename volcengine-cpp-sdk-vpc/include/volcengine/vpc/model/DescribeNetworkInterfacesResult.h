...
*/
#ifndef VOLCENGINE_VPC_DESCRIBENETWORKINTERFACESRESULT_H
#define VOLCENGINE_VPC_DESCRIBENETWORKINTERFACESRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpc{
        ...
        public:
            DescribeNetworkInterfacesResult() = default;
            ~DescribeNetworkInterfacesResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<NetworkInterfaceSetForDescribeNetworkInterfacesOutput> &getNetworkInterfaceSets() const { return  v_networkInterfaceSets; }
            void setNetworkInterfaceSets(const std::vector<NetworkInterfaceSetForDescribeNetworkInterfacesOutput> &s_networkInterfaceSets ) {
                v_networkInterfaceSets = s_networkInterfaceSets;
            }
        ...
        private:
            std::vector<NetworkInterfaceSetForDescribeNetworkInterfacesOutput> v_networkInterfaceSets;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_VPC_DESCRIBENETWORKINTERFACESRESULT_H