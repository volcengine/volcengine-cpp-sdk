...
*/
#ifndef VOLCENGINE_VPC_ROUTETABLEFORDESCRIBESUBNETSOUTPUT_H
#define VOLCENGINE_VPC_ROUTETABLEFORDESCRIBESUBNETSOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpc{
        class RouteTableForDescribeSubnetsOutput {
        public:
            RouteTableForDescribeSubnetsOutput() = default;
            ~RouteTableForDescribeSubnetsOutput() = default;
...
#endif // !VOLCENGINE_VPC_ROUTETABLEFORDESCRIBESUBNETSOUTPUT_H