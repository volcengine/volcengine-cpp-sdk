...
*/
#ifndef VOLCENGINE_VPC_DESCRIBEHAVIPSRESULT_H
#define VOLCENGINE_VPC_DESCRIBEHAVIPSRESULT_H
#include <string>
...
namespace volcengine{
    namespace vpc{
        class DescribeHaVipsResult {
        public:
            DescribeHaVipsResult() = default;
            ~DescribeHaVipsResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<HaVipForDescribeHaVipsOutput> &getHaVips() const { return  v_haVips; }
            void setHaVips(const std::vector<HaVipForDescribeHaVipsOutput> &s_haVips ) {
                v_haVips = s_haVips;
            }
        ...
        private:
            std::vector<HaVipForDescribeHaVipsOutput> v_haVips;
            int v_pageNumber{};
            int v_pageSize{};
...
#endif // !VOLCENGINE_VPC_DESCRIBEHAVIPSRESULT_H