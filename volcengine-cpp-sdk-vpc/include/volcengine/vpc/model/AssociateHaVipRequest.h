...
*/
#ifndef VOLCENGINE_VPC_ASSOCIATEHAVIPREQUEST_H
#define VOLCENGINE_VPC_ASSOCIATEHAVIPREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class AssociateHaVipRequest {
        public:
...
#endif // !VOLCENGINE_VPC_ASSOCIATEHAVIPREQUEST_H