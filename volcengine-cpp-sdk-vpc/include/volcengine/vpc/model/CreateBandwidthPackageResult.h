...
*/
#ifndef VOLCENGINE_VPC_CREATEBANDWIDTHPACKAGERESULT_H
#define VOLCENGINE_VPC_CREATEBANDWIDTHPACKAGERESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpc{
        class CreateBandwidthPackageResult {
        public:
            CreateBandwidthPackageResult() = default;
            ~CreateBandwidthPackageResult() = default;
...
#endif // !VOLCENGINE_VPC_CREATEBANDWIDTHPACKAGERESULT_H