...
*/
#ifndef VOLCENGINE_VPC_TAGFILTERFORDESCRIBEVPCSINPUT_H
#define VOLCENGINE_VPC_TAGFILTERFORDESCRIBEVPCSINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagFilterForDescribeVpcsInput {
        public:
            TagFilterForDescribeVpcsInput();
            ~TagFilterForDescribeVpcsInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFILTERFORDESCRIBEVPCSINPUT_H