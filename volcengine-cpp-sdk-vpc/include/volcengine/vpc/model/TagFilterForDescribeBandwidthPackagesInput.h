...
*/
#ifndef VOLCENGINE_VPC_TAGFILTERFORDESCRIBEBANDWIDTHPACKAGESINPUT_H
#define VOLCENGINE_VPC_TAGFILTERFORDESCRIBEBANDWIDTHPACKAGESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagFilterForDescribeBandwidthPackagesInput {
        public:
            TagFilterForDescribeBandwidthPackagesInput();
            ~TagFilterForDescribeBandwidthPackagesInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFILTERFORDESCRIBEBANDWIDTHPACKAGESINPUT_H