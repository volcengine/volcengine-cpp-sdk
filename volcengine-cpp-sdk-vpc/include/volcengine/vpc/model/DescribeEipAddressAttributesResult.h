...
*/
#ifndef VOLCENGINE_VPC_DESCRIBEEIPADDRESSATTRIBUTESRESULT_H
#define VOLCENGINE_VPC_DESCRIBEEIPADDRESSATTRIBUTESRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
#include "volcengine/vpc/model/TagForDescribeEipAddressAttributesOutput.h"
namespace volcengine{
    namespace vpc{
        class DescribeEipAddressAttributesResult {
        public:
            DescribeEipAddressAttributesResult() = default;
            ~DescribeEipAddressAttributesResult() = default;
            ...
            const std::vector<TagForDescribeEipAddressAttributesOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeEipAddressAttributesOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::string v_status;
            std::vector<TagForDescribeEipAddressAttributesOutput> v_tags;
            std::string v_updatedAt;
        };
    }
}
#endif // !VOLCENGINE_VPC_DESCRIBEEIPADDRESSATTRIBUTESRESULT_H