...
*/
#ifndef VOLCENGINE_VPC_CREATEHAVIPRESULT_H
#define VOLCENGINE_VPC_CREATEHAVIPRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpc{
        class CreateHaVipResult {
        public:
            CreateHaVipResult() = default;
            ~CreateHaVipResult() = default;
...
#endif // !VOLCENGINE_VPC_CREATEHAVIPRESULT_H