...
*/
#ifndef VOLCENGINE_VPC_INGRESSACLENTRYFORDESCRIBENETWORKACLATTRIBUTESOUTPUT_H
#define VOLCENGINE_VPC_INGRESSACLENTRYFORDESCRIBENETWORKACLATTRIBUTESOUTPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpc{
        class IngressAclEntryForDescribeNetworkAclAttributesOutput {
        public:
            IngressAclEntryForDescribeNetworkAclAttributesOutput() = default;
            ~IngressAclEntryForDescribeNetworkAclAttributesOutput() = default;
...
#endif // !VOLCENGINE_VPC_INGRESSACLENTRYFORDESCRIBENETWORKACLATTRIBUTESOUTPUT_H