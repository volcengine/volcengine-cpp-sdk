...
*/
#ifndef VOLCENGINE_VPC_DISASSOCIATEEIPADDRESSREQUEST_H
#define VOLCENGINE_VPC_DISASSOCIATEEIPADDRESSREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class DisassociateEipAddressRequest {
        public:
            DisassociateEipAddressRequest();
            ~DisassociateEipAddressRequest() = default;
...
#endif // !VOLCENGINE_VPC_DISASSOCIATEEIPADDRESSREQUEST_H