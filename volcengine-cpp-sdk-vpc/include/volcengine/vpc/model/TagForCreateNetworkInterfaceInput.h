...
*/
#ifndef VOLCENGINE_VPC_TAGFORCREATENETWORKINTERFACEINPUT_H
#define VOLCENGINE_VPC_TAGFORCREATENETWORKINTERFACEINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagForCreateNetworkInterfaceInput {
        public:
            TagForCreateNetworkInterfaceInput();
            ~TagForCreateNetworkInterfaceInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFORCREATENETWORKINTERFACEINPUT_H