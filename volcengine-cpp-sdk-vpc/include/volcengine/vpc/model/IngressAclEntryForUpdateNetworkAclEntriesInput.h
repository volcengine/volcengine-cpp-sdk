...
*/
#ifndef VOLCENGINE_VPC_INGRESSACLENTRYFORUPDATENETWORKACLENTRIESINPUT_H
#define VOLCENGINE_VPC_INGRESSACLENTRYFORUPDATENETWORKACLENTRIESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class IngressAclEntryForUpdateNetworkAclEntriesInput {
        public:
            IngressAclEntryForUpdateNetworkAclEntriesInput();
            ~IngressAclEntryForUpdateNetworkAclEntriesInput() = default;
            ...
            bool SourceCidrIpHasBeenSet() const { return v_sourceCidrIpHasBeenSet; }
            void setSourceCidrIp(const std::string &s_sourceCidrIp ) {
                v_sourceCidrIp = s_sourceCidrIp;
                v_sourceCidrIpHasBeenSet = true;
            }
        private:
            ...
            bool v_sourceCidrIpHasBeenSet;

        };
    }
}
#endif // !VOLCENGINE_VPC_INGRESSACLENTRYFORUPDATENETWORKACLENTRIESINPUT_H