...
*/
#ifndef VOLCENGINE_VPC_TAGFORTAGRESOURCESINPUT_H
#define VOLCENGINE_VPC_TAGFORTAGRESOURCESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagForTagResourcesInput {
        public:
            TagForTagResourcesInput();
            ~TagForTagResourcesInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFORTAGRESOURCESINPUT_H