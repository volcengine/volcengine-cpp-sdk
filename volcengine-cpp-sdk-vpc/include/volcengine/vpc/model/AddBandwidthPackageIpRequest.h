...
*/
#ifndef VOLCENGINE_VPC_ADDBANDWIDTHPACKAGEIPREQUEST_H
#define VOLCENGINE_VPC_ADDBANDWIDTHPACKAGEIPREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class AddBandwidthPackageIpRequest {
        public:
            AddBandwidthPackageIpRequest();
            ~AddBandwidthPackageIpRequest() = default;
...
#endif // !VOLCENGINE_VPC_ADDBANDWIDTHPACKAGEIPREQUEST_H