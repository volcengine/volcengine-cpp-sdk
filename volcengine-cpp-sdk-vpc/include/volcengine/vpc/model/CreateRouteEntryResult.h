...
*/
#ifndef VOLCENGINE_VPC_CREATEROUTEENTRYRESULT_H
#define VOLCENGINE_VPC_CREATEROUTEENTRYRESULT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>
#include "volcengine/core/utils/json.hpp"
namespace volcengine{
    namespace vpc{
        class CreateRouteEntryResult {
        public:
            CreateRouteEntryResult() = default;
            ~CreateRouteEntryResult() = default;
...
#endif // !VOLCENGINE_VPC_CREATEROUTEENTRYRESULT_H