...
*/
#ifndef VOLCENGINE_VPC_DESCRIBESUBNETATTRIBUTESREQUEST_H
#define VOLCENGINE_VPC_DESCRIBESUBNETATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class DescribeSubnetAttributesRequest {
        public:
            DescribeSubnetAttributesRequest();
            ~DescribeSubnetAttributesRequest() = default;
...
#endif // !VOLCENGINE_VPC_DESCRIBESUBNETATTRIBUTESREQUEST_H