...
*/
#ifndef VOLCENGINE_VPC_NETWORKINTERFACESETFORDESCRIBENETWORKINTERFACESOUTPUT_H
#define VOLCENGINE_VPC_NETWORKINTERFACESETFORDESCRIBENETWORKINTERFACESOUTPUT_H
#include <string>
...
#include "volcengine/vpc/model/TagForDescribeNetworkInterfacesOutput.h"
namespace volcengine{
    namespace vpc{
        class NetworkInterfaceSetForDescribeNetworkInterfacesOutput {
        public:
            NetworkInterfaceSetForDescribeNetworkInterfacesOutput() = default;
            ~NetworkInterfaceSetForDescribeNetworkInterfacesOutput() = default;
            ...
            const std::shared_ptr<PrivateIpSetsForDescribeNetworkInterfacesOutput> &getPrivateIpSets() const { return  v_privateIpSets; }
            void setPrivateIpSets(const std::shared_ptr<PrivateIpSetsForDescribeNetworkInterfacesOutput> &s_privateIpSets ) {
            ...
            const std::vector<TagForDescribeNetworkInterfacesOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeNetworkInterfacesOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::shared_ptr<PrivateIpSetsForDescribeNetworkInterfacesOutput> v_privateIpSets;
            std::string v_projectName;
            std::vector<std::string> v_securityGroupIds;
            bool v_serviceManaged{};
            std::string v_status;
            std::string v_subnetId;
            std::vector<TagForDescribeNetworkInterfacesOutput> v_tags;
            std::string v_type;
...
#endif // !VOLCENGINE_VPC_NETWORKINTERFACESETFORDESCRIBENETWORKINTERFACESOUTPUT_H