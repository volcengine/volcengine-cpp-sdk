...
*/
#ifndef VOLCENGINE_VPC_TAGFILTERFORDESCRIBENETWORKINTERFACESINPUT_H
#define VOLCENGINE_VPC_TAGFILTERFORDESCRIBENETWORKINTERFACESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace vpc{
        class TagFilterForDescribeNetworkInterfacesInput {
        public:
            TagFilterForDescribeNetworkInterfacesInput();
            ~TagFilterForDescribeNetworkInterfacesInput() = default;
...
#endif // !VOLCENGINE_VPC_TAGFILTERFORDESCRIBENETWORKINTERFACESINPUT_H