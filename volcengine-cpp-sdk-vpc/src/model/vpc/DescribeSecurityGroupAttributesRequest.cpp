...
DescribeSecurityGroupAttributesRequest::DescribeSecurityGroupAttributesRequest() = default;

RequestBuilder DescribeSecurityGroupAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeSecurityGroupAttributes");
    ...
    if(v_directionHasBeenSet){
        rb.withQuery(chain + "Direction", v_direction);
