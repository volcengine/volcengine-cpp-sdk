...
ModifyBandwidthPackageAttributesRequest::ModifyBandwidthPackageAttributesRequest() = default;

RequestBuilder ModifyBandwidthPackageAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyBandwidthPackageAttributes");
