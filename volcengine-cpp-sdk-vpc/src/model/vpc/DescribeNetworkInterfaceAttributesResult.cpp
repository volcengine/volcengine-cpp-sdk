...
void DescribeNetworkInterfaceAttributesResult::fromJsonString(const std::string &input) {
    ...
    if (j.contains("AssociatedElasticIp")){
        ...
        auto next = std::make_shared<AssociatedElasticIpForDescribeNetworkInterfaceAttributesOutput>();
    ...
    if (j.contains("PrivateIpSets")){
        ...
        auto next = std::make_shared<PrivateIpSetsForDescribeNetworkInterfaceAttributesOutput>();
    ...
    if (j.contains("Tags")){
        ...
        for (auto & pre : tagsPres) {
           TagForDescribeNetworkInterfaceAttributesOutput next;
