...
TagFilterForDescribeNetworkInterfacesInput::TagFilterForDescribeNetworkInterfacesInput() = default;

RequestBuilder TagFilterForDescribeNetworkInterfacesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
