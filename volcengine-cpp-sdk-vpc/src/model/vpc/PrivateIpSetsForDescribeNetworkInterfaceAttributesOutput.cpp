...
void PrivateIpSetsForDescribeNetworkInterfaceAttributesOutput::fromJsonString(const std::string &input) {
    auto j = json::parse(input);
    if (j.contains("PrivateIpSet")){
        json privateIpSetPres = j.at("PrivateIpSet");
        for (auto & pre : privateIpSetPres) {
           PrivateIpSetForDescribeNetworkInterfaceAttributesOutput next;
