...
ModifySecurityGroupRuleDescriptionsEgressRequest::ModifySecurityGroupRuleDescriptionsEgressRequest(){
    v_portEnd = 0;
...
RequestBuilder ModifySecurityGroupRuleDescriptionsEgressRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifySecurityGroupRuleDescriptionsEgress");
