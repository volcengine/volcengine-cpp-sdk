...
RequestBuilder DeleteBandwidthPackageRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DeleteBandwidthPackage");
