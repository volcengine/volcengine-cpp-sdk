...
RequestBuilder DescribeHaVipsRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeHaVips");
    rb.withQuery("Version","2020-04-01");

    if(v_haVipIdsHasBeenSet){
      unsigned v_haVipIdsCount = 1;
      for(auto& item : v_haVipIds){
        std::stringstream ss;
        ss << chain << "HaVipIds." << v_haVipIdsCount;
