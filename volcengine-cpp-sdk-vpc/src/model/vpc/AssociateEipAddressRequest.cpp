...
RequestBuilder AssociateEipAddressRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","AssociateEipAddress");
    ...
    if(v_privateIpAddressHasBeenSet){
        rb.withQuery(chain + "PrivateIpAddress", v_privateIpAddress);
