...
TagFilterForDescribeEipAddressesInput::TagFilterForDescribeEipAddressesInput() = default;

RequestBuilder TagFilterForDescribeEipAddressesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
