...
AllocateEipAddressRequest::AllocateEipAddressRequest(){
    ...
    v_periodUnit = 0;
    v_periodUnitHasBeenSet = false;
}

RequestBuilder AllocateEipAddressRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","AllocateEipAddress");
    ...
    if(v_periodUnitHasBeenSet){
        rb.withQuery(chain + "PeriodUnit", std::to_string(v_periodUnit));
