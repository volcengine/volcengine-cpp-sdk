...
void DescribeVpcAttributesResult::fromJsonString(const std::string &input) {
    ...
    if (j.contains("AssociateCens")){
        ...
        for (auto & pre : associateCensPres) {
           AssociateCenForDescribeVpcAttributesOutput next;
    ...
    if (j.contains("Tags")){
        ...
        for (auto & pre : tagsPres) {
           TagForDescribeVpcAttributesOutput next;
           next.fromJsonString(to_string(pre));
