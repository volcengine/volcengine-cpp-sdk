...
TagFilterForDescribeBandwidthPackagesInput::TagFilterForDescribeBandwidthPackagesInput() = default;

RequestBuilder TagFilterForDescribeBandwidthPackagesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
