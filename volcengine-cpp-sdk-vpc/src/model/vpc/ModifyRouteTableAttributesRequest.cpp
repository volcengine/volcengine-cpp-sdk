...
RequestBuilder ModifyRouteTableAttributesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","ModifyRouteTableAttributes");
    ...
    if(v_routeTableNameHasBeenSet){
        rb.withQuery(chain + "RouteTableName", v_routeTableName);
