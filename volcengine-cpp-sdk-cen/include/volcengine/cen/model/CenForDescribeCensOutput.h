...
*/
#ifndef VOLCENGINE_CEN_CENFORDESCRIBECENSOUTPUT_H
#define VOLCENGINE_CEN_CENFORDESCRIBECENSOUTPUT_H
#include <string>
...
namespace volcengine{
    namespace cen{
        class CenForDescribeCensOutput {
        public:
            CenForDescribeCensOutput() = default;
            ~CenForDescribeCensOutput() = default;
            ...
            const std::vector<TagForDescribeCensOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeCensOutput> &s_tags ) {
                v_tags = s_tags;
            }
        ...
        private:
            ...
            std::string v_status;
            std::vector<TagForDescribeCensOutput> v_tags;
            std::string v_updateTime;
        };
    }
}
#endif // !VOLCENGINE_CEN_CENFORDESCRIBECENSOUTPUT_H