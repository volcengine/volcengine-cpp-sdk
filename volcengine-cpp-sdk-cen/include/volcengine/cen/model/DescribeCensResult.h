...
*/
#ifndef VOLCENGINE_CEN_DESCRIBECENSRESULT_H
#define VOLCENGINE_CEN_DESCRIBECENSRESULT_H
#include <string>
...
namespace volcengine{
    namespace cen{
        class DescribeCensResult {
        public:
            DescribeCensResult() = default;
            ~DescribeCensResult() = default;
            void fromJsonString(const std::string &input);
            const std::vector<CenForDescribeCensOutput> &getCens() const { return  v_cens; }
            void setCens(const std::vector<CenForDescribeCensOutput> &s_cens ) {
                v_cens = s_cens;
            }
        ...
        private:
            std::vector<CenForDescribeCensOutput> v_cens;
            int v_pageNumber{};
            int v_pageSize{};
            int v_totalCount{};
        };
...
#endif // !VOLCENGINE_CEN_DESCRIBECENSRESULT_H