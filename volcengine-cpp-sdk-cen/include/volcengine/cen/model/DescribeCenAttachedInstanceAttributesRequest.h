...
*/
#ifndef VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCEATTRIBUTESREQUEST_H
#define VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCEATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class DescribeCenAttachedInstanceAttributesRequest {
        public:
            DescribeCenAttachedInstanceAttributesRequest();
            ~DescribeCenAttachedInstanceAttributesRequest() = default;
...
#endif // !VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCEATTRIBUTESREQUEST_H