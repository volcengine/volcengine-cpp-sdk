...
*/
#ifndef VOLCENGINE_CEN_ASSOCIATECENBANDWIDTHPACKAGEREQUEST_H
#define VOLCENGINE_CEN_ASSOCIATECENBANDWIDTHPACKAGEREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class AssociateCenBandwidthPackageRequest {
        public:
...
#endif // !VOLCENGINE_CEN_ASSOCIATECENBANDWIDTHPACKAGEREQUEST_H