...
*/
#ifndef VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCESREQUEST_H
#define VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class DescribeCenAttachedInstancesRequest {
        public:
            DescribeCenAttachedInstancesRequest();
            ~DescribeCenAttachedInstancesRequest() = default;
...
#endif // !VOLCENGINE_CEN_DESCRIBECENATTACHEDINSTANCESREQUEST_H