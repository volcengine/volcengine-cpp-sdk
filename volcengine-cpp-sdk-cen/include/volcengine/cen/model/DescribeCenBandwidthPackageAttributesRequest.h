...
*/
#ifndef VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESREQUEST_H
#define VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class DescribeCenBandwidthPackageAttributesRequest {
        public:
            DescribeCenBandwidthPackageAttributesRequest();
            ~DescribeCenBandwidthPackageAttributesRequest() = default;
...
#endif // !VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESREQUEST_H