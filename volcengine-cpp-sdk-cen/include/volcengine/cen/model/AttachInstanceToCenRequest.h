...
*/
#ifndef VOLCENGINE_CEN_ATTACHINSTANCETOCENREQUEST_H
#define VOLCENGINE_CEN_ATTACHINSTANCETOCENREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class AttachInstanceToCenRequest {
        public:
            AttachInstanceToCenRequest();
            ~AttachInstanceToCenRequest() = default;
            ...
            bool InstanceOwnerIdHasBeenSet() const { return v_instanceOwnerIdHasBeenSet; }
            void setInstanceOwnerId(const std::string &s_instanceOwnerId ) {
                v_instanceOwnerId = s_instanceOwnerId;
                v_instanceOwnerIdHasBeenSet = true;
            }
        ...
        private:
            ...
            bool v_instanceOwnerIdHasBeenSet;
...
#endif // !VOLCENGINE_CEN_ATTACHINSTANCETOCENREQUEST_H