...
*/
#ifndef VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESRESULT_H
#define VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESRESULT_H
#include <string>
...
namespace volcengine{
    namespace cen{
        class DescribeCenBandwidthPackageAttributesResult {
        public:
            DescribeCenBandwidthPackageAttributesResult() = default;
            ~DescribeCenBandwidthPackageAttributesResult() = default;
            ...
            const std::vector<TagForDescribeCenBandwidthPackageAttributesOutput> &getTags() const { return  v_tags; }
            void setTags(const std::vector<TagForDescribeCenBandwidthPackageAttributesOutput> &s_tags ) {
                v_tags = s_tags;
            }
        private:
            ...
            std::string v_status;
            std::vector<TagForDescribeCenBandwidthPackageAttributesOutput> v_tags;
        };
    }
}
#endif // !VOLCENGINE_CEN_DESCRIBECENBANDWIDTHPACKAGEATTRIBUTESRESULT_H