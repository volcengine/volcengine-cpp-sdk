...
*/
#ifndef VOLCENGINE_CEN_GRANTINSTANCETOCENREQUEST_H
#define VOLCENGINE_CEN_GRANTINSTANCETOCENREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class GrantInstanceToCenRequest {
        public:
...
#endif // !VOLCENGINE_CEN_GRANTINSTANCETOCENREQUEST_H