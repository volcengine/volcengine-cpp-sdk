...
*/
#ifndef VOLCENGINE_CEN_DETACHINSTANCEFROMCENREQUEST_H
#define VOLCENGINE_CEN_DETACHINSTANCEFROMCENREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class DetachInstanceFromCenRequest {
        public:
            DetachInstanceFromCenRequest();
            ~DetachInstanceFromCenRequest() = default;
...
#endif // !VOLCENGINE_CEN_DETACHINSTANCEFROMCENREQUEST_H