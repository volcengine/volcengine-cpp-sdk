...
*/
#ifndef VOLCENGINE_CEN_DELETECENSUMMARYROUTEENTRYREQUEST_H
#define VOLCENGINE_CEN_DELETECENSUMMARYROUTEENTRYREQUEST_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class DeleteCenSummaryRouteEntryRequest {
        public:
            DeleteCenSummaryRouteEntryRequest();
            ~DeleteCenSummaryRouteEntryRequest() = default;
...
#endif // !VOLCENGINE_CEN_DELETECENSUMMARYROUTEENTRYREQUEST_H