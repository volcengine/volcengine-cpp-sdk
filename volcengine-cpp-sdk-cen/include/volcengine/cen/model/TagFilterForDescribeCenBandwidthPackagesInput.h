...
*/
#ifndef VOLCENGINE_CEN_TAGFILTERFORDESCRIBECENBANDWIDTHPACKAGESINPUT_H
#define VOLCENGINE_CEN_TAGFILTERFORDESCRIBECENBANDWIDTHPACKAGESINPUT_H
#include <string>
#include <volcengine/core/RequestBuilder.h>

namespace volcengine{
    namespace cen{
        class TagFilterForDescribeCenBandwidthPackagesInput {
        public:
            TagFilterForDescribeCenBandwidthPackagesInput();
            ~TagFilterForDescribeCenBandwidthPackagesInput() = default;
...
#endif // !VOLCENGINE_CEN_TAGFILTERFORDESCRIBECENBANDWIDTHPACKAGESINPUT_H