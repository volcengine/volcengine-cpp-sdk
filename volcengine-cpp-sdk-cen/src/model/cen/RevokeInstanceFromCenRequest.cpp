...
RequestBuilder RevokeInstanceFromCenRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","RevokeInstanceFromCen");
    ...
    if(v_cenOwnerIdHasBeenSet){
        rb.withQuery(chain + "CenOwnerId", v_cenOwnerId);
