...
AttachInstanceToCenRequest::AttachInstanceToCenRequest() = default;

RequestBuilder AttachInstanceToCenRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","AttachInstanceToCen");
    ...
    if(v_instanceOwnerIdHasBeenSet){
        rb.withQuery(chain + "InstanceOwnerId", v_instanceOwnerId);
