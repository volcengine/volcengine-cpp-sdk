...
DeleteCenSummaryRouteEntryRequest::DeleteCenSummaryRouteEntryRequest() = default;

RequestBuilder DeleteCenSummaryRouteEntryRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DeleteCenSummaryRouteEntry");
