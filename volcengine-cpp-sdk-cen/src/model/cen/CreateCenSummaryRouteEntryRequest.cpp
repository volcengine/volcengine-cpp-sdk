...
CreateCenSummaryRouteEntryRequest::CreateCenSummaryRouteEntryRequest() = default;

RequestBuilder CreateCenSummaryRouteEntryRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","CreateCenSummaryRouteEntry");
