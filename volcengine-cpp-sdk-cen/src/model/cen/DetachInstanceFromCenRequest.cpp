...
DetachInstanceFromCenRequest::DetachInstanceFromCenRequest() = default;

RequestBuilder DetachInstanceFromCenRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DetachInstanceFromCen");
