...
DescribeCenRouteEntriesRequest::DescribeCenRouteEntriesRequest(){
    v_pageNumber = 0;
...
RequestBuilder DescribeCenRouteEntriesRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeCenRouteEntries");
