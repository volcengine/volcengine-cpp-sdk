...
RequestBuilder DescribeCensRequest::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
    rb.withQuery("Action","DescribeCens");
    rb.withQuery("Version","2020-04-01");

    if(v_cenIdsHasBeenSet){
        rb.withQuery(chain + "CenIds", v_cenIds);
