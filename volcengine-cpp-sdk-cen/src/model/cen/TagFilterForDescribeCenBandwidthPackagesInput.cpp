...
TagFilterForDescribeCenBandwidthPackagesInput::TagFilterForDescribeCenBandwidthPackagesInput() = default;

RequestBuilder TagFilterForDescribeCenBandwidthPackagesInput::withRequestBuilder(RequestBuilder rb, const std::string &chain) const {
